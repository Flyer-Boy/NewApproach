...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 1", Description: "This is the first tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 400000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_1_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPDocument_t1.pdf", Description: "This is the Tender 1 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_1_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPResponseTemplate-t1.pdf", Description: "This is the Tender 1 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_1_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPPresentation_t1.pdf", Description: "This is the Tender 1 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 2", Description: "This is the second tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 200000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_2_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brandon/Tender2/RFPDocument_t2.pdf", Description: "This is the Tender 2 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_2_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brndon/Tender2/RFPResponseTemplate-t2.pdf", Description: "This is the Tender 2 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 3", Description: "This is the third tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 300000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_3_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPDocument_t3.pdf", Description: "This is the Tender 3 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_3_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPResponseTemplate-t3.pdf", Description: "This is the Tender 3 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_3_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPPresentation_t3.pdf", Description: "This is the Tender 3 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 4", Description: "This is the third tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 40000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_4_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender4/RFQDocument_t4.pdf", Description: "This is the Tender 4 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_4_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender4/RFQResponseTemplate-t4.pdf", Description: "This is the Tender 4 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 5", Description: "This is the fifth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 200000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_5_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Eduard/Tender5/RFPDocument_t5.pdf", Description: "This is the Tender 5 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_5_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Eduard/Tender5/RFPResponseTemplate-t5.pdf", Description: "This is the Tender 5 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 6", Description: "This is the sixth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 300000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_6_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Fred/Tender6/RFPDocument_t6.pdf", Description: "This is the Tender 6 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_6_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Fred/Tender6/RFPResponseTemplate-t6.pdf", Description: "This is the Tender 6 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 7", Description: "This is the seventh tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 400000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_7_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Gilbert/Tender7/RFPDocument_t7.pdf", Description: "This is the Tender 7 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_7_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Gilbert/Tender7/RFPResponseTemplate-t7.pdf", Description: "This is the Tender 7 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 8", Description: "This is the Tender 8 for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 100000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_8_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Harold/Tender8/RFQDocument_t8.pdf", Description: "This is the Tender 8 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_8_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Harold/Tender8/RFQResponseTemplate-t8.pdf", Description: "This is the Tender 8 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});      
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 9", Description: "This is the tenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 180000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9/RFQDocument_t9.pdf", Description: "This is the Tender 9 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9/RFQResponseTemplate-t9.pdf", Description: "This is the Tender 9 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi, I have a question about the tender. Can you please clarify the budget?"})-[:SENT_BY]->(l1);

MATCH (e:Employee)<-[:HAS_REQUESTER]-(t:Tender {Title: "Tender 1"})-[:HAS_CHAT]->(c) 
CREATE  (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m2:Message {Text: "Sure, the budget is 400000 in order to include the international deployment as discussed on the meeting of March 10th. Is there anything else you need?"})-[:SENT_BY]->(e);

MATCH (t:Tender {Title: "Tender 1"})-[:HAS_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m3:Message {Text: "No, that will be all. Thank you!"})-[:SENT_BY]->(l1);           
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi, I have a question about the tender. Can you please clarify the criteria for selecting the 2 vendors?"})-[:SENT_BY]->(l2);
...
CREATE  (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m2:Message {Text: "Sure, the criteria are based on the vendors experience and the price they offered in previous tenders. Is there anything else you need?"})-[:SENT_BY]->(e);

// Let's have the Approver 2 (Sara) Reply.
MATCH (t:Tender {Title: "Tender 2"})-[:HAS_CHAT]->(c), (l2:Employee {Name: "Sara"}) 
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m3:Message {Text: "No, that will be all. Thank you!"})-[:SENT_BY]->(l2);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi Ingrid, I have a question about the tender. Reading thrugh the documentation, it seems that this Tender is not complient with our Tender norms as per Schedule 11?"})-[:SENT_BY]->(l1);

MATCH (e:Employee)<-[:HAS_REQUESTER]-(t:Tender {Title: "Tender 9"})-[:HAS_CHAT]->(c) 
CREATE  (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m2:Message {Text: "Opps, my bad! You are right. We overlooked this part. Sorry"})-[:SENT_BY]->(e);

MATCH (t:Tender {Title: "Tender 9"})-[:HAS_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m3:Message {Text: "No Proble. I will reject it. So if you are willing to move forward, fix the compliance parts and resubmit it. Thank you!"})-[:SENT_BY]->(l1);          
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 9.1", Description: "This is the tenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 180000 })<-[:HAS]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_1_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9_1/RFQDocument_t9_1.pdf", Description: "This is the Tender 9.1 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_1_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9_1/RFQResponseTemplate-t9_1.pdf", Description: "This is the Tender 9.1 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}),
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 1)."})-[:SENT_BY]->(e);
...
MATCH (v:Vendor {ShortName: "Vendor 7"})<-[:HAS]-(:ApprovedVendorS)
        CREATE (iv)-[:HAS {relType:"HAS_INVITED_VENDOR",Date: localdatetime.transaction()}]->(v);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 3)."})-[:SENT_BY]->(e);
...
UNWIND COLLECT {MATCH (v:Vendor)<-[:HAS]-(:ApprovedVendorS) RETURN v} AS vendor
        CREATE (iv)-[:HAS {relType:"HAS_INVITED_VENDOR",Date: localdatetime.transaction()}]->(vendor);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 4)."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 5)."})-[:SENT_BY]->(e);
...
CREATE (ti)-[:HAS {relType: "HAS_ACCEPTED_TENDER", Date: localdatetime.transaction()}]->(t);
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B79c69d9843ff", Title: "Title of Bid for Tender 1 from Vendor 7", Description: "Description of Bid for Tender 1 from Vendor 7", Scope: "Scope of Bid for Tender 1 from Vendor 7", Deliverables: "List of deliverables of Bid for Tender 1 from Vendor 7", CompletitionDate:  localdatetime.transaction() + duration({days: 90}), Price: 80000, Conditions: "Vendor 7 Conditions for Bid of Tender 1", Qualifications: "Vendor 7 qualifications for Tender 1",  SubmissionDate: localdatetime.transaction()})<-[:HAS {relType: "HAS_BID", Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T1-V7", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT1_V7_01.pdf", Description: "This is the description of the RFP Document", Date: localdatetime.transaction()}),
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Title of Bid for Tender 1 from Vendor 4", Description: "Description of Bid for Tender 1 from Vendor 4", Scope: "Scope of Bid for Tender 1 from Vendor 4", Deliverables: "List of deliverables of Bid for Tender 1 from Vendor 4", CompletitionDate:  localdatetime.transaction() + duration({days: 75}), Price: 75000, Conditions: "Vendor 4 Conditions for Bid of Tender 1", Qualifications: "Vendor 4 qualifications for Tender 1", SubmissionDate: localdatetime.transaction()})<-[:HAS {relType: "HAS_BID", Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T1-V4", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT1_V4_01.pdf", Description: "This is the description of the RFP Document", Date: localdatetime.transaction()}),
       (b)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B784981c5b0cc", Title: "Title of Bid for Tender 4 from Vendor 8", Description: "Description of Bid for Tender 4 from Vendor 8", Scope: "Scope of Bid for Tender 4 from Vendor 8", Deliverables: "List of deliverables of Bid for Tender 4 from Vendor 8", CompletitionDate:  localdatetime.transaction() + duration({days: 75}), Price: 75000, Conditions: "Vendor 8 Conditions for Bid of Tender 4", Qualifications: "Vendor 8 qualifications for Tender 4", SubmissionDate: localdatetime.transaction()})<-[:HAS {relType: "HAS_BID", Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T4-V8", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFQDocT4_V8_01.pdf", Description: "This is the description of the Bid RFQ Document", Date: localdatetime.transaction()}),
       (b)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "Tender 4 is now officially Closed for bidding. We will communicate the results as soon as we have an awarded bid. Thanks for participating."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi, I have a question about the bid. Can you please justify the price and delivery dates?"})-[:SENT_BY]->(e);

MATCH (vc:VendorContact)<-[:HAS_CONTACT]-(v:Vendor)<-[:HAS_VENDOR]-(b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c)
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m2:Message {Text: "Hi Albert. Sure, the price is 80000 given the complexity of the project. As we will need to bring extra resources and might have to hire a few new resources, the timeframe might be a bit longer than usual. Is there anything else you need?"})-[:SENT_BY]->(vc);

MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c), (e:Employee {Name: "Albert"})  
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m3:Message {Text: "Thanks, Herbert. No, that will be all. Thank you!"})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m4:Message {Text: "Hi Herbert, this is Gloria from the Approval team and I would like to know how committed you are for delivering on the proposed time?"})-[:SENT_BY]->(l1);

// The Vendor 7 contact person will reply to Gloria's question
MATCH (vc:VendorContact)<-[:HAS_CONTACT]-(v:Vendor)<-[:HAS_VENDOR]-(b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c)
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m5:Message {Text: "Hi Gloria, we are fully committed to delivering on the proposed time. We have the resources and the expertise to deliver on time. Is there anything else you need?"})-[:SENT_BY]->(vc);

// Gloria thanks the Vendor 7 contact person for the reply
MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c), (l1:Employee {Name: "Gloria"})  
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m6:Message {Text: "Thanks Herbert, that will be all from my side. Thanks!"})-[:SENT_BY]->(l1);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "Congratulations! The Bid for Tender 1 has been awarded to you! We look forward for to starting the Project as soon as possible."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "The Bid for Tender 1 has not been awarded to you. We thank you for your participation and look forward to working with you in the future."})-[:SENT_BY]->(e);
...
MATCH (em:Employee {Name: "Albert"}), (nt:NewTenderS {Name: "NewTenderS"}), (ty:TenderType {Name: "Open"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 10", Description: "This is the tenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 20}) , Budget: 100000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_10_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPDocument_t10.pdf", Description: "This is the Tender 10 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_10_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender10/RFPResponseTemplate-t10.pdf", Description: "This is the Tender 10 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_10_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender10/RFPPresentation_t10.pdf", Description: "This is the Tender 10 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Brandon"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Selective"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 11", Description: "This is the eleventh tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 500000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_11_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brandon/Tender11/RFPDocument_t11.pdf", Description: "This is the Tender 11 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_11_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brndon/Tender11/RFPResponseTemplate-t11.pdf", Description: "This is the Tender 11 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Charles"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Negotiated"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 12", Description: "This is the twelvth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 45}) , Budget: 1300000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_12_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPDocument_t12.pdf", Description: "This is the Tender 12 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_12_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPResponseTemplate-t12.pdf", Description: "This is the Tender 12 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_12_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPPresentation_t12.pdf", Description: "This is the Tender 12 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Donald"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Open"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 13", Description: "This is the thirteenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 70000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_13_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender13/RFQDocument_t13.pdf", Description: "This is the Tender 13 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_13_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender13/RFQResponseTemplate-t13.pdf", Description: "This is the Tender 13 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 10)."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 12)."})-[:SENT_BY]->(e);
