...
(:InventoryLevel {UnitsInStock: "", LastUpdate: ""})<-[:CURRENT_STOCK]-(n7)<-[:SUPPLIES]-(n6)-[:HAS_CONTACT]->(n8:Contact {ContactName: "", ContactTitle: "", Email: "", Fax: "", Phone: ""})<-[:HAS_CONTACT]-(n10:Customer {CustomerID: "", CompanyName: ""})<-[:HAS_CUSTOMER]-(n11:Order {OrderID: "", OrderDate: "", RequireDate: ""})-[:HAS_SHIPMENT]->(n13:ShipInfo {ShippmentID: "", ShippedDate: ""})-[:HAS_SHIPPER]->(:Shipper {ShipperID: "", CompanyName: ""})-[:HAS_CONTACT]->(n8),
