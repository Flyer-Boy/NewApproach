...
CREATE (:Notes {Notes: ""})<-[:HAS_NOTES]-(n0:Emplyee {EmployeeID: "", HireDate: "", PhotoPath: "", Email: "", Extension: ""})-[: HAS_ADDRESS]->(Address {Address: "", City: "", Region: "", PostalCode: "", Country: ""})<-[:HAS_ADDRESS]-(n6:Supplier {SupplierID: "", CompanyName: "", HomePage: ""})<-[:HAS_SUPPLIER]-(n7:Product {ProductID: "", ProductName: "", QuantityPerUnit: "", UnitPrice: "", PicturePath: "", ReorderLevel: ""})<-[:HAS {RelType: "IS_DISCONTINUED"}]-(:ProductStatus_DiscontinueD {Status: "Discontinued"}),
...
(:InventoryLevel {UnitesInStock: ""})<-[:CURRENT_STOCK]-(n7)<-[:SUPPLIES]-(n6)-[:HAS_CONTACT]->(n8:Contact {ContactName: "", ContactTitle: "", Email: ""})<-[:HAS_CONTACT]-(n10:Customer {CustomerID: "", CompanyName: ""})<-[:HAS_CUSTOMER]-(n11:Order {OrderID: "", OrderDate: "", RequireDate: ""})-[:HAS_SHIPMENT]->(n13:ShipInfo {ShippmentID: "", ShippedDate: ""})-[:HAS_SHIPPER]->(:Shipper {ShipperID: "", CompanyName: ""})-[:HAS_CONTACT]->(n8),
(n13)-[:HAS__SHIPPMENT_ADDRESS]->(Address)<-[:HAS_ADDRESS]-(n10),
