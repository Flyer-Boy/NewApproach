...
CREATE CONSTRAINT ON (n:Passenger)
ASSERT n.Phone IS UNIQUE;  

// Address (GeoHash) is a Proper Noun, so we set a Unique Constraint on the GeoHash 

 CREATE CONSTRAINT ON (a:Address)
 ASSERT a.GeoHash IS UNIQUE;  
...
MATCH (ps:PassengerS) 
CREATE  (ps)-[:HAS]->(p:Passenger {Name: "Antonio", Phone: "23456683", Email: "Antonio@email.com" , Photo: "/src/assets/images/People/4140048.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), 
...
(w)-[:HAS]->(pm3:PaymentMethod {Type: "Cash" , CardNumber: 0}),
...
MATCH (ps:PassengerS) 
CREATE  (ps)-[:HAS]->(p:Passenger {Name: "Lucy", Phone: "83987809", Email: "Lucy@email.com" , Photo: "/src/assets/images/People/4139997.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), 
(p)-[:HAS_WALLET]->(w:WalleT {Name: "WalleT"})-[:HAS]->(pm1:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Lucy Diamond", CardNumber: 5426070000106565, ExpDate: "10/26", CVV: 370}),
(w)-[:HAS]->(pm2:PaymentMethod {Type: "DebitCard", Issuer: "Visa", NameOnCard: "Lucy Diamond", CardNumber: 4512950622668258, ExpDate: "02/26", CVV: 109}),
(w)-[:HAS]->(pm3:PaymentMethod {Type: "Cash" , CardNumber: 0}),
(p)-[:HAS_PREFERED_PAYMENT]->(pm1),
(p)-[:HAS_ADDRESS]->(ab:AddressBooK {Name:"AddressBooK"});
...
CREATE  (ps)-[:HAS]->(p:Passenger {Name: "Peter", Phone: "98456683", Email: "Peter@email.com" , Photo: "/src/assets/images/People/4140042.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), 
...
CREATE CONSTRAINT ON (n:Car)
ASSERT n.Plate IS UNIQUE;

CREATE CONSTRAINT ON (n:Driver)
...
CREATE  (d1:Driver {Name: "Albert", ID: "S12345678N", License: "SG144445578", Phone: "443344331", Email: "Albert@email.com" , Photo: "/src/assets/images/People/4139948.png" })-[:HAS_CAR]->(c1:Car { Plate: "ABC-1234", Make: "Toyota", Model:"Prius", Year: 2022, Capacity: 4, Color: "White"})-[:HAS_DRIVER]->(d1), 
(d1)<-[:HAS]-(dc), 
...
(c1)-[:IS_AT]->(:Loc {GeoHash: "9xj3fc4xfeyx" , Time: localDateTime()}),
(c1)<-[:HAS]-(p);
...
CREATE CONSTRAINT ON (n:Booking)
ASSERT n.BookingID IS UNIQUE; 
...
OPTIONAL MATCH (p:PendinG {Name: "PendinG"}), (dc:DriverS {Name: "DriverS"})
CREATE  (d2:Driver {Name: "Brandon", ID: "S84765968N", License: "SG454435548", Phone: "944453321", Email: "Brandon@email.com" , Photo: "/src/assets/images/People/4139993.png"})-[:HAS_CAR]->(c2:Car { Plate: "ABC-5678", Make: "Honda", Model:"Vezel", Year: 2021, Capacity: 4, Color: "Red"})-[:HAS_DRIVER]->(d2), (c2)<-[:HAS]-(p), (d2)<-[:HAS]-(dc) , (d2)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d2)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c2)-[:IS_AT]->(:Loc {GeoHash: "9xj3fc4xfeyx" , Time: LocalDateTime()}),
        (d3:Driver {Name: "Charles", ID: "S324538736N", License: "SG35664433", Phone: "997766544", Email: "Charles@email.com" , Photo: "/src/assets/images/People/4140050.png" })-[:HAS_CAR]->(c3:Car { Plate: "ABD-1234", Make: "Toyota", Model:"Corolla", Year: 2023, Capacity: 4, Color: "Blue"})-[:HAS_DRIVER]->(d3), (c3)<-[:HAS]-(p), (d3)<-[:HAS]-(dc) , (d3)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d3)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c3)-[:IS_AT]->(:Loc {GeoHash: "9xj3f3yvpp2c" , Time: LocalDateTime()}),
        (d4:Driver {Name: "Donald", ID: "S67828333N", License: "SG876443334", Phone: "944455541", Email: "Donald@email.com" , Photo: "/src/assets/images/People/4140057.png"})-[:HAS_CAR]->(c4:Car { Plate: "ABD-5678", Make: "Toyota", Model:"C-HR", Year: 2019, Capacity: 4, Color: "Green"})-[:HAS_DRIVER]->(d4), (c4)<-[:HAS]-(p), (d4)<-[:HAS]-(dc) , (d4)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d4)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c4)-[:IS_AT]->(:Loc {GeoHash: "9xj3f3m219hj" , Time: LocalDateTime()}),
        (d5:Driver {Name: "Eduard", ID: "S98376432N", License: "SG865434938", Phone: "955445551", Email: "Eduard@email.com" , Photo: "/src/assets/images/People/4140037.png"})-[:HAS_CAR]->(c5:Car { Plate: "ABE-1234", Make: "Toyota", Model:"Prius", Year: 2020, Capacity: 4, Color: "White"})-[:HAS_DRIVER]->(d5), (c5)<-[:HAS]-(p), (d5)<-[:HAS]-(dc) , (d5)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d5)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c5)-[:IS_AT]->(:Loc {GeoHash: "9xj3g789wbtx" , Time: LocalDateTime()}),
        (d6:Driver {Name: "Fred", ID: "S25984432N", License: "SG14564336", Phone: "909876665", Email: "Fred@email.com" , Photo: "/src/assets/images/People/4139981.png"})-[:HAS_CAR]->(c6:Car { Plate: "ABE-5678", Make: "Honda", Model:"Freed", Year: 2022, Capacity: 4, Color: "Black"})-[:HAS_DRIVER]->(d6), (c6)<-[:HAS]-(p), (d6)<-[:HAS]-(dc) , (d6)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d6)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c6)-[:IS_AT]->(:Loc {GeoHash: "9xj3gq7rw9p4" , Time: LocalDateTime()}),
        (d7:Driver {Name: "Gilbert", ID: "S093983333N", License: "SG94877448", Phone: "55446773", Email: "Gilbert@email.com" , Photo: "/src/assets/images/People/4140055.png"})-[:HAS_CAR]->(c7:Car { Plate: "ABF-1234", Make: "Toyota", Model:"C-HR", Year: 2021, Capacity: 4, Color: "Yellow"})-[:HAS_DRIVER]->(d7), (c7)<-[:HAS]-(p), (d7)<-[:HAS]-(dc) , (d7)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d7)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c7)-[:IS_AT]->(:Loc {GeoHash: "9xj64mn04zdd" , Time: LocalDateTime()}),
        (d8:Driver {Name: "Harold", ID: "S763663638N", License: "SG4454433", Phone: "484747443", Email: "Harold@email.com" , Photo: "/src/assets/images/People/4140063.png"})-[:HAS_CAR]->(c8:Car { Plate: "ABF-5678", Make: "Honda", Model:"Civic", Year: 2019, Capacity: 4, Color: "Red"})-[:HAS_DRIVER]->(d8), (c8)<-[:HAS]-(p), (d8)<-[:HAS]-(dc) , (d8)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d8)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c8)-[:IS_AT]->(:Loc {GeoHash: "9xj67ser8kcb" , Time: LocalDateTime()}),
        (d9:Driver {Name: "Ingrid", ID: "S18487473N", License: "SG55678943", Phone: "998474731", Email: "Ingrid@email.com" , Photo: "/src/assets/images/People/4140060.png"})-[:HAS_CAR]->(c9:Car { Plate: "ABG-1234", Make: "Toyota", Model:"Sienna", Year: 2022, Capacity: 4, Color: "Blue"})-[:HAS_DRIVER]->(d9), (c9)<-[:HAS]-(p), (d9)<-[:HAS]-(dc) , (d9)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d9)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c9)-[:IS_AT]->(:Loc {GeoHash: "9xj6mndvvcpq" , Time: LocalDateTime()}),
        (d10:Driver {Name: "Juliet", ID: "S17477328N", License: "SG12379744", Phone: "998474744", Email: "Juliet@email.com" , Photo: "/src/assets/images/People/4140078.png" })-[:HAS_CAR]->(c10:Car { Plate: "ABG-5678", Make: "Toyota", Model:"Hilux", Year: 2023, Capacity: 4, Color: "White"})-[:HAS_DRIVER]->(d10), (c10)<-[:HAS]-(p), (d10)<-[:HAS]-(dc) , (d10)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d10)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c10)-[:IS_AT]->(:Loc {GeoHash: "9xj70j09fu78" , Time: LocalDateTime()}) ;
...
SET l.GeoHash = "9xj70hjbrgtu", l.Time =LocalDateTime();
...
// Create another 9 Cars, 9  Drivers, but this time we connect Cars to AvailablE collection, Connect Cars to individual HistorY collection, Connect Cars to individual Location node, Connect Driver to DriverS collection 

OPTIONAL MATCH (a:AvailablE {Name: "AvailablE"}), (dc:DriverS {Name: "DriverS"})
CREATE  (d2:Driver {Name: "Keneth", ID: "T84735968N", License: "SG409335548", Phone: "9494453321", Email: "Keneth@email.com" , Photo: "/src/assets/images/People/6997675.png"})-[:HAS_CAR]->(c2:Car { Plate: "ARP-6207", Make: "Honda", Model:"Vezel", Year: 2023, Capacity: 4, Color: "Red"})-[:HAS_DRIVER]->(d2), (c2)<-[:HAS]-(a), (d2)<-[:HAS]-(dc) , (d2)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d2)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c2)-[:IS_AT]->(:Loc {GeoHash: "9xj3fc4xfeyx" , Time: LocalDateTime()}),
        (d3:Driver {Name: "Marlon", ID: "T324518736N", License: "SG71064433", Phone: "9909136544", Email: "Marlon@email.com" , Photo: "/src/assets/images/People/4140050.png" })-[:HAS_CAR]->(c3:Car { Plate: "EZJ-6206", Make: "Tesla", Model:"Model 3", Year: 2023, Capacity: 4, Color: "Blue"})-[:HAS_DRIVER]->(d3), (c3)<-[:HAS]-(a), (d3)<-[:HAS]-(dc) , (d3)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d3)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c3)-[:IS_AT]->(:Loc {GeoHash: "9xj3f3yvpp2c" , Time: LocalDateTime()}),
        (d4:Driver {Name: "Nelson", ID: "T67028333N", License: "SG874043334", Phone: "9449851541", Email: "Nelson@email.com" , Photo: "/src/assets/images/People/4140057.png"})-[:HAS_CAR]->(c4:Car { Plate: "OLM-7209", Make: "Toyota", Model:"C-HR", Year: 2019, Capacity: 4, Color: "Green"})-[:HAS_DRIVER]->(d4), (c4)<-[:HAS]-(a), (d4)<-[:HAS]-(dc) , (d4)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d4)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c4)-[:IS_AT]->(:Loc {GeoHash: "9xj3f3m219hj" , Time: LocalDateTime()}),
        (d5:Driver {Name: "Robert", ID: "T98846432N", License: "SG871434938", Phone: "9551062551", Email: "Robert@email.com" , Photo: "/src/assets/images/People/4140037.png"})-[:HAS_CAR]->(c5:Car { Plate: "RXK-8352", Make: "BYD", Model:"Tang", Year: 2024, Capacity: 4, Color: "White"})-[:HAS_DRIVER]->(d5), (c5)<-[:HAS]-(a), (d5)<-[:HAS]-(dc) , (d5)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d5)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c5)-[:IS_AT]->(:Loc {GeoHash: "9xj3g789wbtx" , Time: LocalDateTime()}),
        (d6:Driver {Name: "Mary", ID: "T25980932N", License: "SG10914336", Phone: "909870092", Email: "Mary@email.com" , Photo: "/src/assets/images/People/4140076.png"})-[:HAS_CAR]->(c6:Car { Plate: "VNR-9734", Make: "Hyundai", Model:"Palisade", Year: 2023, Capacity: 4, Color: "Black"})-[:HAS_DRIVER]->(d6), (c6)<-[:HAS]-(a), (d6)<-[:HAS]-(dc) , (d6)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d6)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c6)-[:IS_AT]->(:Loc {GeoHash: "9xj3gq7rw9p4" , Time: LocalDateTime()}),
        (d7:Driver {Name: "Gloria", ID: "T093982633N", License: "SG97307448", Phone: "559831373", Email: "Gloria@email.com" , Photo: "/src/assets/images/People/4140047.png"})-[:HAS_CAR]->(c7:Car { Plate: "OAB-9633", Make: "BYD", Model:"Dolphin", Year: 2024, Capacity: 4, Color: "Yellow"})-[:HAS_DRIVER]->(d7), (c7)<-[:HAS]-(a), (d7)<-[:HAS]-(dc) , (d7)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d7)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c7)-[:IS_AT]->(:Loc {GeoHash: "9xj64mn04zdd" , Time: LocalDateTime()}),
        (d8:Driver {Name: "Sara", ID: "T763663208N", License: "SG44783433", Phone: "4849810343", Email: "Sara@email.com" , Photo: "/src/assets/images/People/4143768.png"})-[:HAS_CAR]->(c8:Car { Plate: "KNG-8801", Make: "Peugeot", Model:"508 SW", Year: 2019, Capacity: 4, Color: "Red"})-[:HAS_DRIVER]->(d8), (c8)<-[:HAS]-(a), (d8)<-[:HAS]-(dc) , (d8)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d8)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c8)-[:IS_AT]->(:Loc {GeoHash: "9xj67ser8kcb" , Time: LocalDateTime()}),
        (d9:Driver {Name: "Christine", ID: "T14987473N", License: "SG59838943", Phone: "9998344731", Email: "Christine@email.com" , Photo: "/src/assets/images/People/4140071.png"})-[:HAS_CAR]->(c9:Car { Plate: "PYZ-9812", Make: "VW", Model:"Passat", Year: 2022, Capacity: 4, Color: "Silver"})-[:HAS_DRIVER]->(d9), (c9)<-[:HAS]-(a), (d9)<-[:HAS]-(dc) , (d9)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d9)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c9)-[:IS_AT]->(:Loc {GeoHash: "9xj6mndvvcpq" , Time: LocalDateTime()}),
        (d10:Driver {Name: "Cloe", ID: "T17488328N", License: "SG12104744", Phone: "998195044", Email: "Cloe@email.com" , Photo: "/src/assets/images/People/4140069.png" })-[:HAS_CAR]->(c10:Car { Plate: "GNK-8899", Make: "Testa", Model:"Model 3", Year: 2024, Capacity: 4, Color: "White"})-[:HAS_DRIVER]->(d10), (c10)<-[:HAS]-(a), (d10)<-[:HAS]-(dc) , (d10)-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (d10)-[:HAS_WALLET]->(:WalleT {Name: "WalleT"}), (c10)-[:IS_AT]->(:Loc {GeoHash: "9xj70j09fu78" , Time: LocalDateTime()}) ;
...
MATCH (pc:PassengerS)
CREATE  (pc)-[:HAS]->(p2:Passenger {Name: "Benson", Phone: "40985343" , Email: "Benson@email.com" , Photo: "/src/assets/images/People/4140039.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p2)-[:HAS_WALLET]->(w2:WalleT {Name: "WalleT"})-[:HAS]->(pm2:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Benson Tan", CardNumber: 5554740400899688, ExpDate: "08/26", CVV: 883}), (p2)-[:HAS_PREFERED_PAYMENT]->(pm2), (p2)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w2)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p3:Passenger {Name: "Cleber", Phone: "56230987" , Email: "Cleber@email.com" , Photo: "/src/assets/images/People/4140061.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p3)-[:HAS_WALLET]->(w3:WalleT {Name: "WalleT"})-[:HAS]->(pm3:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Cleber Santos", CardNumber: 5590120400374378, ExpDate: "04/26", CVV: 700}), (p3)-[:HAS_PREFERED_PAYMENT]->(pm3), (p3)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w3)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p4:Passenger {Name: "David", Phone: "29837442" , Email: "David@email.com" , Photo: "/src/assets/images/People/4140046.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p4)-[:HAS_WALLET]->(w4:WalleT {Name: "WalleT"})-[:HAS]->(pm4:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "David Copperland", CardNumber: 5590120400468360, ExpDate: "02/26", CVV: 126}), (p4)-[:HAS_PREFERED_PAYMENT]->(pm4), (p4)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w4)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p5:Passenger {Name: "Ernest", Phone: "89207651" , Email: "Ernest@email.com" , Photo: "/src/assets/images/People/4140077.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p5)-[:HAS_WALLET]->(w5:WalleT {Name: "WalleT"})-[:HAS]->(pm5:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Ernest Hemingroad", CardNumber: 5590120400077120, ExpDate: "10/28", CVV: 664}), (p5)-[:HAS_PREFERED_PAYMENT]->(pm5), (p5)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w5)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p6:Passenger {Name: "Frank", Phone: "78383822" , Email: "Frank@email.com" , Photo: "/src/assets/images/People/4140059.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p6)-[:HAS_WALLET]->(w6:WalleT {Name: "WalleT"})-[:HAS]->(pm6:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Frank Zatta", CardNumber: 5590120400844131, ExpDate: "03/26", CVV: 493}), (p6)-[:HAS_PREFERED_PAYMENT]->(pm6), (p6)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w6)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p7:Passenger {Name: "Gunter", Phone: "30982321" , Email: "Gunter@email.com" , Photo: "/src/assets/images/People/4140079.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p7)-[:HAS_WALLET]->(w7:WalleT {Name: "WalleT"})-[:HAS]->(pm7:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Gunter Schmidt", CardNumber: 5554740400521373, ExpDate: "05/26", CVV: 833}), (p7)-[:HAS_PREFERED_PAYMENT]->(pm7), (p7)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w7)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p8:Passenger {Name: "Herbert", Phone: "78323862" , Email: "Herbert@email.com" , Photo: "/src/assets/images/People/4139970.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p8)-[:HAS_WALLET]->(w8:WalleT {Name: "WalleT"})-[:HAS]->(pm8:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Herbert Richards", CardNumber: 5590120400473279, ExpDate: "07/26", CVV: 287}), (p8)-[:HAS_PREFERED_PAYMENT]->(pm8), (p8)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w8)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p9:Passenger {Name: "Igor", Phone: "40989221" , Email: "Igor@email.com" , Photo: "/src/assets/images/People/4139955.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p9)-[:HAS_WALLET]->(w9:WalleT {Name: "WalleT"})-[:HAS]->(pm9:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Igor Stravonsky", CardNumber: 5554740400770046, ExpDate: "08/27", CVV: 357}), (p9)-[:HAS_PREFERED_PAYMENT]->(pm9), (p9)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w9)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p10:Passenger {Name: "John", Phone: "94003822" , Email: "John@email.com" , Photo: "/src/assets/images/People/7879063.png"})-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p10)-[:HAS_WALLET]->(w10:WalleT {Name: "WalleT"})-[:HAS]->(pm10:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "John Lemon", CardNumber: 5554740400123295, ExpDate: "11/27", CVV: 488}), (p10)-[:HAS_PREFERED_PAYMENT]->(pm10), (p10)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w10)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}),
        (pc)-[:HAS]->(p11:Passenger {Name: "Karl", Phone: "820042321" , Email: "Karl@email.com", Photo: "/src/assets/images/People/4140066.png" })-[:HAS_HISTORY]->(:HistorY {Name: "HistorY"}), (p11)-[:HAS_WALLET]->(w11:WalleT {Name: "WalleT"})-[:HAS]->(pm11:PaymentMethod {Type: "CreditCard", Issuer: "MasterCard", NameOnCard: "Karl Mix", CardNumber: 5554740400497350, ExpDate: "12/28", CVV: 786}), (p11)-[:HAS_PREFERED_PAYMENT]->(pm11), (p11)-[:HAS_ADDRESS]->(:AddressBooK {Name:"AddressBooK"}), (w11)-[:HAS]->(:PaymentMethod {Type: "Cash", CardNumber: 0}); 
        


// Time to start Booking

// Let's Create some Random but real and valid GeoHash Addresses to use later on our Demo. These are all random but existing Denver, CO adresses with their respective GeoHash 
...
CREATE (:Address {GeoHash: "9xj70g6z1xry", StreetNum: 390, StreetName: "Hemlock St", City: "Denver", State: "CO", ZIP: 80200})<-[:HAS]-(ad),
       ...
       (:Address {GeoHash: "9xj3c1g68fbv", StreetNum: 1298, StreetName: "S Marshall St", City: "Lakewood", State: "CO", ZIP: 80232})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj3chve7t8f", StreetNum:  400, StreetName: "S Kendall St", City: "Lakewood", State: "CO", ZIP: 80226})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj3v4zz1mcz", StreetNum:  9071, StreetName: "E Mississippi Ave", City: "Denver", State: "CO", ZIP: 80247})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj62t89t5xz", StreetNum:  5730, StreetName: "Dudley St", City: "Arvada", State: "CO", ZIP: 80002})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj6ducfsd6p", StreetNum:  561, StreetName: "W 79th Pl", City: "Denver", State: "CO", ZIP: 80221})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj652847whd", StreetNum:  821, StreetName: "Corona St", City: "Denver", State: "CO", ZIP: 80218})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj6h1j8n3n2", StreetNum:  4567, StreetName: "E 9th Ave", City: "Denver", State: "CO", ZIP: 80220})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj3uu69xq5j", StreetNum:  579, StreetName: "S Poplar Way", City: "Denver", State: "CO", ZIP: 80224})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj3tn25gdv0", StreetNum:  2369, StreetName: "S Trenton Way", City: "Denver", State: "CO", ZIP: 80231})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj6nggfrqy4", StreetNum:  14895, StreetName: "E Montview Blvd", City: "Aurora", State: "CO", ZIP: 80011})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj6q7cw4drz", StreetNum:  5353, StreetName: "Tucson St", City: "Denver", State: "CO", ZIP: 80239})<-[:HAS]-(ad),
       (:Address {GeoHash: "9xj6jv3u8ukf", StreetNum:  2762, StreetName: "Jamaica Way", City: "Denver", State: "CO", ZIP: 80238})<-[:HAS]-(ad);
...
CREATE (b:Booking {BookingID: "B09637f9d543c", Date: LocalDateTime(), Fare: ceil(rand()*20)+10 })-[:HAS_PASSENGER]->(p),
       (b)-[:HAS_PAYMENT]->(pm),
       (b)-[:HAS_ORIGIN]->(oa),
...
// If we want to create a Dynamic pricing based on Supply vs Demand we can use the below Cypher Qaurey 
//
// MATCH (c:Car)<-[:HAS]-(:AvailablE)
// CALL {MATCH (b:Booking)<-[:HAS]-(:WaitinG) RETURN toFloat(count(b)) AS Bookings_Waiting}
// WITH Bookings_Waiting, toFloat(count (c)) as Cars_Available RETURN round(toFloat(Bookings_Waiting/(Cars_Available+0.1)*ceil(rand()*20)+10,2) as Fare




// Driver - Find Bookings that are Waiting  
...
CREATE (a)-[:HAS]->(b),
       ...
       (b)-[t:HAS_CAR {Date:LocalDateTime()}]->(c),
       (u)-[:HAS]->(c);

// 2.5 - Driver Picks up the Passenger:

MATCH (d:Driver {ID: "S84765968N"})-[:HAS_CAR]->(c)-[:HAS_ACTIVE_BOOKING]->(b: Booking {BookingID: "B09637f9d543c" }) CREATE (b)-[:PICKED_UP {Date:LocalDateTime()}]->(c);
...
CREATE (t)-[:HAS {Date:LocalDateTime()}]->(b), 
      (a)-[:HAS]->(c), 
      (dh)-[:HAS {Date:LocalDateTime()}]->(b),
      (b)<-[:HAS {Date:LocalDateTime()}]-(ph) 
DELETE r1, r2, r3, r4;
...
CREATE (b)-[:HAS_RATING]->(r:Rating {Date:LocalDateTime(), Stars: 4, Comments: "Good ride, good navigaton, polite driver"});
...
CREATE (b:Booking {BookingID: "B85518e3420c7", Date: LocalDateTime(), Fare: ceil(rand()*20)+10 })-[:HAS_PASSENGER]->(p),
       (b)-[:HAS_PAYMENT]->(pm),
       (b)-[:HAS_ORIGIN]->(oa),
       (b)-[:HAS_DESTINATION]->(da),
       (p)-[:HAS_ACTIVE_BOOKING]->(b), 
...
CREATE (b:Booking {BookingID: "B22318cb24f70", Date: LocalDateTime(), Fare: ceil(rand()*20)+10 })-[:HAS_PASSENGER]->(p),
       (b)-[:HAS_PAYMENT]->(pm),
       (b)-[:HAS_ORIGIN]->(oa),
       (b)-[:HAS_DESTINATION]->(da),
       (p)-[:HAS_ACTIVE_BOOKING]->(b), 
...
CREATE (b:Booking {BookingID: "B60b8e871d140", Date: LocalDateTime(), Fare: ceil(rand()*20)+10 })-[:HAS_PASSENGER]->(p), 
       (b)-[:HAS_PAYMENT]->(pm),
       (b)-[:HAS_ORIGIN]->(oa),
       (b)-[:HAS_DESTINATION]->(da),
       (p)-[:HAS_ACTIVE_BOOKING]->(b), 
...
CREATE (b:Booking {BookingID: "B28096628141b", Date: LocalDateTime(), Fare: ceil(rand()*20)+10 })-[:HAS_PASSENGER]->(p),
       (b)-[:HAS_PAYMENT]->(pm),
       (b)-[:HAS_ORIGIN]->(oa),
       (b)-[:HAS_DESTINATION]->(da),
       (p)-[:HAS_ACTIVE_BOOKING]->(b), 
...
// Aditional Booking for Passenger Lucy using the random BookingID formula

OPTIONAL MATCH  (p:Passenger {Phone: "83987809"})-[:HAS_PREFERED_PAYMENT]-(pm), (w:WaitinG {Name: "WaitinG"}), (oa:Address {GeoHash: "9xj62t89t5xz"})<-[:HAS]-(:AddresseS)-[:HAS]->(da:Address {GeoHash: "9xj6q7cw4drz"})
CREATE (b:Booking {BookingID: "B"+left(randomUUID(),8)+right(randomUUID(),4), Date: LocalDateTime(), Fare: ceil(rand()*20)+10 })-[:HAS_PASSENGER]->(p),
       (b)-[:HAS_PAYMENT]->(pm),
       (b)-[:HAS_ORIGIN]->(oa),
       (b)-[:HAS_DESTINATION]->(da),
       (p)-[:HAS_ACTIVE_BOOKING]->(b), 
...
OPTIONAL MATCH  (p:Passenger {Phone: "23456683"})-[:HAS_PREFERED_PAYMENT]-(pm), (w:WaitinG {Name: "WaitinG"}), (oa:Address {GeoHash: "9xj6cvxyeen7"})<-[:HAS]-(:AddresseS)-[:HAS]->(da:Address {GeoHash: "9xj6nggfrqy4"})
CREATE (b:Booking {BookingID: "Be0ad83f4eca1", Date: LocalDateTime() ,  Fare: ceil(rand()*20)+10 })-[:HAS_PASSENGER]->(p),
       (b)-[:HAS_PAYMENT]->(pm),
       (b)-[:HAS_ORIGIN]->(oa),
       (b)-[:HAS_DESTINATION]->(da),
       (p)-[:HAS_ACTIVE_BOOKING]->(b), 
...
// Driver has not Picked Up the passenger yet
...
DELETE r 
CREATE (c)<-[:HAS {Date:LocalDateTime()}]-(e); 
