...
// ----- Or watch a presentation about the concepts and approaches used at https://youtu.be/ExupBmmH1Rs -----


// -----  Here we go!!!  ----- 

// Before we start, let's clear all Nodes and relationships and drop all constraints in case we have run this script before.   
 
MATCH (n) DETACH DELETE n; 

DROP CONSTRAINT ON (t:TenderS) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (t:NewTenderS) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (t:ApprovedTenderS) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (t:RejectedTenderS) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (t:AwardedTenderS) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (t:ClosedTenderS) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (t:TenderTypeS) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (t:TenderType) ASSERT t.Name IS UNIQUE; 
DROP CONSTRAINT ON (e:TmployeeDirectorY) ASSERT e.Name IS UNIQUE; 
DROP CONSTRAINT ON (r:RoleS) ASSERT r.Name IS UNIQUE; 
DROP CONSTRAINT ON (r:RolE) ASSERT r.Name IS UNIQUE; 
DROP CONSTRAINT ON (v:VendorS) ASSERT v.Name IS UNIQUE; 
DROP CONSTRAINT ON (v:PendingVendorS) ASSERT v.Name IS UNIQUE;
DROP CONSTRAINT ON (v:ApprovedVendorS) ASSERT v.Name IS UNIQUE;
DROP CONSTRAINT ON (v:RejectedVendorS) ASSERT v.Name IS UNIQUE;
DROP CONSTRAINT ON (v:Vendor) ASSERT v.VendorCode IS UNIQUE;
DROP CONSTRAINT ON (t:Tender) ASSERT t.TenderCode IS UNIQUE;
DROP CONSTRAINT ON (b:Bid) ASSERT b.BidCode IS UNIQUE;
...
CREATE (t:TenderS {Name: "TenderS"})-[:HAS {relType:"HAS_TENDER_STATE"}]->(:NewTenderS {Name: "NewTenderS"}),
       (t)-[:HAS {relType:"HAS_TENDER_STATE"}]->(:ApprovedTenderS {Name: "ApprovedTenderS"}),
       (t)-[:HAS {relType:"HAS_TENDER_STATE"}]->(:RejectedTenderS {Name: "RejectedTenderS"}),
       (t)-[:HAS {relType:"HAS_TENDER_STATE"}]->(:PublishedTenderS {Name: "PublishedTenderS"}),
       (t)-[:HAS {relType:"HAS_TENDER_STATE"}]->(:AwardedTenderS {Name: "AwardedTenderS"}),
       (t)-[:HAS {relType:"HAS_TENDER_STATE"}]->(:ClosedTenderS {Name: "ClosedTenderS"});
       
CREATE CONSTRAINT ON (t:TenderS) 
ASSERT t.Name IS UNIQUE; 

CREATE CONSTRAINT ON (t:NewTenderS)
ASSERT t.Name IS UNIQUE; 

CREATE CONSTRAINT ON (t:ApprovedTenderS)
ASSERT t.Name IS UNIQUE; 

CREATE CONSTRAINT ON (t:RejectedTenderS)
ASSERT t.Name IS UNIQUE; 

CREATE CONSTRAINT ON (t:AwardedTenderS)
ASSERT t.Name IS UNIQUE; 

CREATE CONSTRAINT ON (t:ClosedTenderS)
ASSERT t.Name IS UNIQUE; 


// For Tender Types I will use a Common Label (:TenderType) and different Property ({Name})
//Create the Tender Types
CREATE (ty:TenderTypeS {Name: "TenderTypeS"})-[:HAS {relType:"HAS_TENDER_TYPE"}]->(:TenderType {Name: "Open", Description: "Open Tender", Rules: "Open to all vendors"}),
         (ty)-[:HAS {relType:"HAS_TENDER_TYPE"}]->(:TenderType {Name: "Selective", Description: "Selective Tender", Rules: "Only selected vendors can bid"}),
         (ty)-[:HAS {relType:"HAS_TENDER_TYPE"}]->(:TenderType {Name: "Negotiated", Description: "Negotiated Tender", Rules: "Negotiation with selected vendors"}),
         (ty)-[:HAS {relType:"HAS_TENDER_TYPE"}]->(:TenderType {Name: "Framework", Description: "Framework Tender", Rules: "Long-term agreement with selected vendors"}),
         (ty)-[:HAS {relType:"HAS_TENDER_TYPE"}]->(:TenderType {Name: "DirectAward", Description: "Direct Award Tender", Rules: "Directly awarded to a vendor without bidding"});
 

CREATE CONSTRAINT ON (t:TenderTypeS)
ASSERT t.Name IS UNIQUE; 

CREATE CONSTRAINT ON (t:TenderType)
ASSERT t.Name IS UNIQUE; 
...
CREATE CONSTRAINT ON (e:TmployeeDirectorY)
...
CREATE (r:RoleS {Name: "RoleS"})-[:HAS {relType:"HAS_ROLE_TYPE"}]->(:RolE {Name: "Requester", Description: "Requester", Rules: "Requests Tenders"}),
       ...
       (r)-[:HAS {relType:"HAS_ROLE_TYPE"}]->(:RolE {Name: "Publisher" , Description: "Publisher", Rules: "Publishes Tenders"});
...
CREATE (v:VendorS {Name: "VendorS"})-[:HAS {relType:"HAS_VENDOR_STATE"}]->(:PendingVendorS {Name: "PendingVendorS"}),
       (v)-[:HAS {relType:"HAS_VENDOR_STATE"}]->(:ApprovedVendorS {Name: "ApprovedVendorS"}),
       (v)-[:HAS {relType:"HAS_VENDOR_STATE"}]->(:RejectedVendorS {Name: "RejectedVendorS"});
       
CREATE CONSTRAINT ON (v:VendorS)
ASSERT v.Name IS UNIQUE; 

CREATE CONSTRAINT ON (v:PendingVendorS)
ASSERT v.Name IS UNIQUE;

CREATE CONSTRAINT ON (v:ApprovedVendorS)
ASSERT v.Name IS UNIQUE;

CREATE CONSTRAINT ON (v:RejectedVendorS)
ASSERT v.Name IS UNIQUE;
...
CREATE  (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e1:Employee {Name: "Albert", ID: "S12345678N", Phone: "443344331", Email: "Albert@email.com" , Photo: "/src/assets/images/People/4139948.png" })<-[:HAS {relType:"IS_ROLE"}]-(rq),
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e2:Employee {Name: "Brandon", ID: "S84765968N", Phone: "944453321", Email: "Brandon@email.com" , Photo: "/src/assets/images/People/4139993.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq), 
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e3:Employee {Name: "Charles", ID: "S324538736N", Phone: "997766544", Email: "Charles@email.com" , Photo: "/src/assets/images/People/4140050.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq), 
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e4:Employee {Name: "Donald", ID: "S67828333N",  Phone: "944455541", Email: "Donald@email.com" , Photo: "/src/assets/images/People/4140057.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq),  
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e5:Employee {Name: "Eduard", ID: "S98376432N",  Phone: "955445551", Email: "Eduard@email.com" , Photo: "/src/assets/images/People/4140037.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq), 
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e6:Employee {Name: "Fred", ID: "S25984432N",  Phone: "909876665", Email: "Fred@email.com" , Photo: "/src/assets/images/People/4139981.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq),  
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e7:Employee {Name: "Gilbert", ID: "S093983333N", Phone: "55446773", Email: "Gilbert@email.com" , Photo: "/src/assets/images/People/4140055.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq), 
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e8:Employee {Name: "Harold", ID: "S763663638N",  Phone: "484747443", Email: "Harold@email.com" , Photo: "/src/assets/images/People/4140063.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq), 
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e9:Employee {Name: "Ingrid", ID: "S18487473N",  Phone: "998474731", Email: "Ingrid@email.com" , Photo: "/src/assets/images/People/4140060.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq), 
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e10:Employee {Name: "Juliet", ID: "S17477328N",Phone: "998474744", Email: "Juliet@email.com" , Photo: "/src/assets/images/People/4140078.png" })<-[:HAS {relType:"IS_ROLE"}]-(rq),
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e11:Employee {Name: "Keneth", ID: "T84735968N",  Phone: "9494453321", Email: "Keneth@email.com" , Photo: "/src/assets/images/People/6997675.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq),
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e12:Employee {Name: "Marlon", ID: "T324518736N", Phone: "9909136544", Email: "Marlon@email.com" , Photo: "/src/assets/images/People/4140050.png" })<-[:HAS {relType:"IS_ROLE"}]-(rq),
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e13:Employee {Name: "Nelson", ID: "T67028333N", Phone: "9449851541", Email: "Nelson@email.com" , Photo: "/src/assets/images/People/4140057.png"})<-[:HAS {relType:"IS_ROLE"}]-(rq);

MATCH (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (va:RolE {Name: "VendorApprover"})
CREATE  (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e14:Employee {Name: "Robert", ID: "T98846432N", Phone: "9551062551", Email: "Robert@email.com" , Photo: "/src/assets/images/People/4140037.png"})<-[:HAS {relType:"IS_ROLE"}]-(va),
        (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e15:Employee {Name: "Mary", ID: "T25980932N", Phone: "909870092", Email: "Mary@email.com" , Photo: "/src/assets/images/People/4140076.png"})<-[:HAS {relType:"IS_ROLE"}]-(va);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (l1:RolE {Name: "Level1Approver"})
CREATE  (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e16:Employee {Name: "Gloria", ID: "T093982633N", Phone: "559831373", Email: "Gloria@email.com" , Photo: "/src/assets/images/People/4140047.png"})<-[:HAS {relType:"IS_ROLE"}]-(l1);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (l2:RolE {Name: "Level2Approver"})       
CREATE  (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e17:Employee {Name: "Sara", ID: "T763663208N", Phone: "4849810343", Email: "Sara@email.com" , Photo: "/src/assets/images/People/4143768.png"})<-[:HAS {relType:"IS_ROLE"}]-(l2);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (l3:RolE {Name: "Level3Approver"})
CREATE  (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e18:Employee {Name: "Christine", ID: "T14987473N", Phone: "9998344731", Email: "Christine@email.com" , Photo: "/src/assets/images/People/4140071.png"})<-[:HAS {relType:"IS_ROLE"}]-(l3);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (p:RolE {Name: "Publisher"})
CREATE  (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(e19:Employee {Name: "Cloe", ID: "T17488328N", Phone: "998195044", Email: "Cloe@email.com" , Photo: "/src/assets/images/People/4140069.png" })<-[:HAS {relType:"IS_ROLE"}]-(p);
...
CREATE (ed)-[:HAS {relType:"HAS_EMPLOYEE"}]->(:Employee {Name: "System", ID: "SYSTEM"});



// --------- Vendors

CREATE CONSTRAINT ON (v:Vendor)
ASSERT v.VendorCode IS UNIQUE;
...
CREATE (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v1:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 1", LegalName: "Vendor One Pte Ltd", RegistrartionNumber: "SG409335548", Logo: "/src/assets/images/vlogo1.jpg"})-[:HAS_CONTACT]->(vc1:VendorContact {Name: "Benson", Phone: "40985343" , Email: "Benson@v1email.com" , Photo: "/src/assets/images/People/4140039.png"}), (v1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v1)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor1/Vendor1RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()}),
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v2:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 2", LegalName: "Vendor Two Pte Ltd", RegistrartionNumber: "SG409335549", Logo: "/src/assets/images/vlogo2.jpg"})-[:HAS_CONTACT]->(vc2:VendorContact {Name: "Cleber", Phone: "56230987" , Email: "Cleber@v2email.com" , Photo: "/src/assets/images/People/4140061.png"}), (v2)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v2)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d2:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor2/Vendor2RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()}),     
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v3:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 3", LegalName: "Vendor Three Pte Ltd", RegistrartionNumber: "SG409335550", Logo: "/src/assets/images/vlogo3.jpg"})-[:HAS_CONTACT]->(vc3:VendorContact {Name: "David", Phone: "29837442" , Email: "David@v3email.com" , Photo: "/src/assets/images/People/4140046.png"}), (v3)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v3)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d3:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor3/Vendor3RFIDoc.pdf", Description: "TVendor RFI template response", Date: LocalDateTime()}),   
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v4:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 4", LegalName: "Vendor Four Pte Ltd", RegistrartionNumber: "SG409335551", Logo: "/src/assets/images/vlogo4.jpg"})-[:HAS_CONTACT]->(vc4:VendorContact {Name: "Ernest", Phone: "89207651" , Email: "Ernest@v4email.com" , Photo: "/src/assets/images/People/4140077.png"}), (v4)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v4)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d4:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor4/Vendor4RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()}),   
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v5:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 5", LegalName: "Vendor Five Pte Ltd", RegistrartionNumber: "SG409335552", Logo: "/src/assets/images/vlogo5.jpg"})-[:HAS_CONTACT]->(vc5:VendorContact {Name: "Frank", Phone: "78383822" , Email: "Frank@v5email.com" , Photo: "/src/assets/images/People/4140059.png"}), (v5)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v5)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d5:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor5/Vendor5RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()});
 
MATCH (pv:PendingVendorS {Name: "PendingVendorS"}) 
CREATE (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v6:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 6", LegalName: "Vendor Six Pte Ltd", RegistrartionNumber: "SG409335553", Logo: "/src/assets/images/vlogo6.jpg"})-[:HAS_CONTACT]->(vc6:VendorContact {Name: "Gunter", Phone: "30982321" , Email: "Gunter@v6email.com" , Photo: "/src/assets/images/People/4140079.png"}), (v6)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v6)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d6:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor6/Vendor6RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()}),
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v7:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 7", LegalName: "Vendor Seven Pte Ltd", RegistrartionNumber: "SG409335554", Logo: "/src/assets/images/vlogo7.jpg"})-[:HAS_CONTACT]->(vc7:VendorContact {Name: "Herbert", Phone: "78323862" , Email: "Herbert@v7email.com" , Photo: "/src/assets/images/People/4139970.png"}), (v7)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v7)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d7:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Vendor7RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()}),
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v8:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 8", LegalName: "Vendor Eight Pte Ltd", RegistrartionNumber: "SG409335555", Logo: "/src/assets/images/vlogo8.jpg"})-[:HAS_CONTACT]->(vc8:VendorContact {Name: "Igor", Phone: "40989221" , Email: "Igor@v8email.com" , Photo: "/src/assets/images/People/4139955.png"}), (v8)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v8)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d8:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor8/Vendor8RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()}),
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v9:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 9", LegalName: "Vendor Nine Pte Ltd", RegistrartionNumber: "SG409335556", Logo: "/src/assets/images/vlogo9.jpg"})-[:HAS_CONTACT]->(vc9:VendorContact {Name: "John", Phone: "94003822" , Email: "John@v9email.com" , Photo: "/src/assets/images/People/7879063.png"}), (v9)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v9)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d9:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor9/Vendor9RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()}),
       (pv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v10:Vendor {VendorCode: "V"+left(randomUUID(),8)+right(randomUUID(),4), ShortName: "Vendor 10", LegalName: "Vendor Ten Pte Ltd", RegistrartionNumber: "SG409335557", Logo: "/src/assets/images/vlogo10.jpg"})-[:HAS_CONTACT]->(vc10:VendorContact {Name: "Karl", Phone: "820042321" , Email: "Karl@v10email.com", Photo: "/src/assets/images/People/4140066.png"}), (v10)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}), (v10)-[:HAS_DOCS]->(:VendorDocS {Name: "VendorDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d10:Doc {DocName: "VendorRFIDoc", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor10/Vendor10RFIDoc.pdf", Description: "Vendor RFI template response", Date: LocalDateTime()});
...
WITH v 
CREATE (v)-[:HAS_AI_AGENT_ASSESMENT {Date: LocalDateTime()}]->(:AIVendorAssesment {Rating: rand(), 
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:HAS]->(v:Vendor {ShortName: "Vendor 1"}), (l1:Employee {Name: "Robert"})<-[:HAS]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:HAS]->(v:Vendor {ShortName: "Vendor 3"}), (l1:Employee {Name: "Mary"})<-[:HAS]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v),
       (v)-[:HAS_ACCEPTED_INVITATONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:HAS]->(v:Vendor {ShortName: "Vendor 4"}), (l1:Employee {Name: "Robert"})<-[:HAS]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v),
       (v)-[:HAS_ACCEPTED_INVITATONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:HAS]->(v:Vendor {ShortName: "Vendor 7"}), (l1:Employee {Name: "Mary"})<-[:HAS]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v),
       (v)-[:HAS_ACCEPTED_INVITATONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:HAS]->(v:Vendor {ShortName: "Vendor 8"}), (l1:Employee {Name: "Robert"})<-[:HAS]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v),
       (v)-[:HAS_ACCEPTED_INVITATONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:HAS]->(v:Vendor {ShortName: "Vendor 10"}), (l1:Employee {Name: "Mary"})<-[:HAS]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v),
       (v)-[:HAS_ACCEPTED_INVITATONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:HAS]->(v:Vendor {ShortName: "Vendor 2"}), (l1:Employee {Name: "Robert"})<-[:HAS]-(:RolE {Name: "VendorApprover"}), (rv:RejectedVendorS {Name: "RejectedVendorS"}) 
CREATE (v)-[:HAS_L1_REJECTION {Date: LocalDateTime(), Comment: "This vendor is rejected"}]->(l1),
       (rv)-[:HAS {relType:"IS_VENDOR_STATE"}]->(v)
       DELETE r1;
...
CREATE CONSTRAINT ON (t:Tender)
ASSERT t.TenderCode IS UNIQUE;
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 1", Description: "This is the first tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 400000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_1_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPDocument_t1.pdf", Description: "This is the Tender 1 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_1_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPResponseTemplate-t1.pdf", Description: "This is the Tender 1 RFP mandatory response template", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_1_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPPresentation_t1.pdf", Description: "This is the Tender 1 RFP Presentation", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 2", Description: "This is the second tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 200000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_2_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brandon/Tender2/RFPDocument_t2.pdf", Description: "This is the Tender 2 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_2_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brndon/Tender2/RFPResponseTemplate-t2.pdf", Description: "This is the Tender 2 RFP mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 3", Description: "This is the third tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 300000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_3_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPDocument_t3.pdf", Description: "This is the Tender 3 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_3_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPResponseTemplate-t3.pdf", Description: "This is the Tender 3 RFP mandatory response template", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_3_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPPresentation_t3.pdf", Description: "This is the Tender 3 RFP Presentation", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 4", Description: "This is the third tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 40000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_4_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender4/RFQDocument_t4.pdf", Description: "This is the Tender 4 RFQ Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_4_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender4/RFQResponseTemplate-t4.pdf", Description: "This is the Tender 4 RFQ mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 5", Description: "This is the fifth tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 200000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_5_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Eduard/Tender5/RFPDocument_t5.pdf", Description: "This is the Tender 5 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_5_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Eduard/Tender5/RFPResponseTemplate-t5.pdf", Description: "This is the Tender 5 RFP mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 6", Description: "This is the sixth tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 300000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_6_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Fred/Tender6/RFPDocument_t6.pdf", Description: "This is the Tender 6 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_6_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Fred/Tender6/RFPResponseTemplate-t6.pdf", Description: "This is the Tender 6 RFP mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 7", Description: "This is the seventh tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 400000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_7_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Gilbert/Tender7/RFPDocument_t7.pdf", Description: "This is the Tender 7 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_7_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Gilbert/Tender7/RFPResponseTemplate-t7.pdf", Description: "This is the Tender 7 RFP mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 8", Description: "This is the Tender 8 for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 100000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_8_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Harold/Tender8/RFQDocument_t8.pdf", Description: "This is the Tender 8 RFQ Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_8_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Harold/Tender8/RFQResponseTemplate-t8.pdf", Description: "This is the Tender 8 RFQ mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});      
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 9", Description: "This is the tenth tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 180000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9/RFQDocument_t9.pdf", Description: "This is the Tender 9 RFQ Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9/RFQResponseTemplate-t9.pdf", Description: "This is the Tender 9 RFQ mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m1:Message {Text: "Hi, I have a question about the tender. Can you please clarify the budget?"})-[:SENT_BY]->(l1);

MATCH (e:Employee)<-[:HAS_REQUESTER]-(t:Tender {Title: "Tender 1"})-[:HAS_CHAT]->(c) 
CREATE  (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m2:Message {Text: "Sure, the budget is 400000 in order to include the international deployment as discussed on the meeting of March 10th. Is there anything else you need?"})-[:SENT_BY]->(e);

MATCH (t:Tender {Title: "Tender 1"})-[:HAS_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m3:Message {Text: "No, that will be all. Thank you!"})-[:SENT_BY]->(l1);           
...
CREATE (t)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This tender is approved"}]->(l1);
...
CREATE (t)-[:HAS_L2_APPROVAL {Date: LocalDateTime(), Comment: "This tender is approved"}]->(l2);
...
CREATE (t)-[:HAS_L3_APPROVAL {Date: LocalDateTime(), Comment: "This tender is approved"}]->(l3),
       (at)-[:HAS {relType:"IS_TENDER_STATE"}]->(t)
DELETE r1;
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m1:Message {Text: "Hi, I have a question about the tender. Can you please clarify the criteria for selecting the 2 vendors?"})-[:SENT_BY]->(l2);
...
CREATE  (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m2:Message {Text: "Sure, the criteria are based on the vendors experience and the price they offered in previous tenders. Is there anything else you need?"})-[:SENT_BY]->(e);

// Let's have the Approver 2 (Sara) Reply.
MATCH (t:Tender {Title: "Tender 2"})-[:HAS_CHAT]->(c), (l2:Employee {Name: "Sara"}) 
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m3:Message {Text: "No, that will be all. Thank you!"})-[:SENT_BY]->(l2);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m1:Message {Text: "Hi Ingrid, I have a question about the tender. Reading thrugh the documentation, it seems that this Tender is not complient with our Tender norms as per Schedule 11?"})-[:SENT_BY]->(l1);

MATCH (e:Employee)<-[:HAS_REQUESTER]-(t:Tender {Title: "Tender 9"})-[:HAS_CHAT]->(c) 
CREATE  (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m2:Message {Text: "Opps, my bad! You are right. We overlooked this part. Sorry"})-[:SENT_BY]->(e);

MATCH (t:Tender {Title: "Tender 9"})-[:HAS_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m3:Message {Text: "No Proble. I will reject it. So if you are willing to move forward, fix the compliance parts and resubmit it. Thank you!"})-[:SENT_BY]->(l1);          
...
CREATE (t)-[:HAS_L1_REJECTION {Date: LocalDateTime(), Comment: "This tender is rejected"}]->(l1),
       (rv)-[:HAS {relType:"IS_TENDER_STATE"}]->(t) 
DELETE r1;
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 9.1", Description: "This is the 9.1 tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 180000 })<-[:HAS]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_1_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9_1/RFQDocument_t9_1.pdf", Description: "This is the Tender 9.1 RFQ Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_9_1_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9_1/RFQResponseTemplate-t9_1.pdf", Description: "This is the Tender 9.1 RFQ mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"}),
...
CREATE (t)-[:HAS_PUBLISHER_APPROVAL {Date: LocalDateTime(), Comment: "This tender is approved for Publishing"}]->(p),
       (t)-[:HAS_INVITEES]->(:InvitedVendorS {Name: "InvitedVendorS"}),
       (t)-[:HAS_BIDS]->(:TenderBidS {Name: "TenderBidS"}),
       (pt)-[:HAS {relType:"IS_TENDER_STATE"}]->(t)
DELETE r1;       
...
MATCH (v:Vendor)<-[:HAS]-(:ApprovedVendorS)
CREATE (iv)-[:HAS {relType:"HAS_INVITED_VENDOR",Date: LocalDateTime()}]->(v);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 1)."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 3)."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 4)."})-[:SENT_BY]->(e);
...
MATCH (v:Vendor)<-[:HAS]-(:ApprovedVendorS) WHERE v.ShortName = "Vendor 7" OR v.ShortName = "Vendor 8"   
CREATE (iv)-[:HAS {relType:"HAS_INVITED_VENDOR",Date: LocalDateTime()}]->(v);


// Now we must communicate all the Tender 4 invitees about their invitation so they can decide if they want to participat in the Tender.
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 5"})-[:HAS_INVITEES]->()-[:HAS]->(v)-[:HAS_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 5)."})-[:SENT_BY]->(e);
...
MATCH (v:Vendor {ShortName: "Vendor 7"})<-[:HAS]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender)<-[:HAS]-(:PublishedTenderS), (t)-[:HAS_TYPE]-(ty:TenderType) 
RETURN t.TenderCode, t.Title, t.Description, t.SubmissionDate, t.Budget, ty.Name;
...
CREATE (ti)-[:HAS {relType: "HAS_ACCEPTED_TENDER", Date: LocalDateTime()}]->(t);
...
CREATE CONSTRAINT ON (b:Bid)
ASSERT b.BidCode IS UNIQUE;
...
MATCH (v:Vendor {ShortName: "Vendor 7"})-[:HAS_ACCEPTED_INVITATONS]->()-[:HAS]->(t)-[:HAS_DOCS]->()-[:HAS]->(d), (t)-[:HAS_TYPE]->(y) 
RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL;
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: LocalDateTime()}]->(b:Bid {BidCode: "B79c69d9843ff", Title: "Title of Bid for Tender 1 from Vendor 7", Description: "Description of Bid for Tender 1 from Vendor 7", Scope: "Scope of Bid for Tender 1 from Vendor 7", Deliverables: "List of deliverables of Bid for Tender 1 from Vendor 7", CompletitionDate:  LocalDateTime() + duration({day: 90}), Price: 80000, Conditions: "Vendor 7 Conditions for Bid of Tender 1", Qualifications: "Vendor 7 qualifications for Tender 1",  SubmissionDate: LocalDateTime()})<-[:HAS {relType: "HAS_BID", Date: LocalDateTime()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T1-V7", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT1_V7_01.pdf", Description: "This is the description of the RFP Document", Date: LocalDateTime()}),
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: LocalDateTime()}]->(b:Bid {BidCode: "B"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Title of Bid for Tender 3 from Vendor 7", Description: "Description of Bid for Tender 3 from Vendor 7", Scope: "Scope of Bid for Tender 3 from Vendor 7", Deliverables: "List of deliverables of Bid for Tender 3 from Vendor 7", CompletitionDate:  LocalDateTime() + duration({day: 160}), Price: 290000, Conditions: "Vendor 7 Conditions for Bid of Tender 3", Qualifications: "Vendor 7 qualifications for Tender 3", SubmissionDate: LocalDateTime()})<-[:HAS {relType: "HAS_BID", Date: LocalDateTime()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T3-V7", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT3_V7_01.pdf", Description: "This is the description of the RFP Document", Date: LocalDateTime()}),
       (b)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});                                 
...
MATCH (v:Vendor {ShortName: "Vendor 4"})-[:HAS_ACCEPTED_INVITATONS]->()-[:HAS]->(t)-[:HAS_DOCS]->()-[:HAS]->(d), (t)-[:HAS_TYPE]->(y) 
RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL;
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: LocalDateTime()}]->(b:Bid {BidCode: "B"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Title of Bid for Tender 1 from Vendor 4", Description: "Description of Bid for Tender 1 from Vendor 4", Scope: "Scope of Bid for Tender 1 from Vendor 4", Deliverables: "List of deliverables of Bid for Tender 1 from Vendor 4", CompletitionDate:  LocalDateTime() + duration({day: 75}), Price: 75000, Conditions: "Vendor 4 Conditions for Bid of Tender 1", Qualifications: "Vendor 4 qualifications for Tender 1", SubmissionDate: LocalDateTime()})<-[:HAS {relType: "HAS_BID", Date: LocalDateTime()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T1-V4", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT1_V4_01.pdf", Description: "This is the description of the RFP Document", Date: LocalDateTime()}),
       (b)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (v:Vendor {ShortName: "Vendor 3"})-[:HAS_ACCEPTED_INVITATONS]->()-[:HAS]->(t)-[:HAS_DOCS]->()-[:HAS]->(d), (t)-[:HAS_TYPE]->(y) 
RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL;
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: LocalDateTime()}]->(b:Bid {BidCode: "B"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Title of Bid for Tender 4 from Vendor 3", Description: "Description of Bid for Tender 4 from Vendor 3", Scope: "Scope of Bid for Tender 4 from Vendor 3", Deliverables: "List of deliverables of Bid for Tender 4 from Vendor 3", CompletitionDate:  LocalDateTime() + duration({day: 75}), Price: 75000, Conditions: "Vendor 3 Conditions for Bid of Tender 4", Qualifications: "Vendor 3 qualifications for Tender 4", SubmissionDate: LocalDateTime()})<-[:HAS {relType: "HAS_BID", Date: LocalDateTime()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T4-V3", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFQDocT4_V3_01.pdf", Description: "This is the description of the Bid RFQ Document", Date: LocalDateTime()}),
       (b)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (v:Vendor {ShortName: "Vendor 8"})-[:HAS_ACCEPTED_INVITATONS]->()-[:HAS]->(t)-[:HAS_DOCS]->()-[:HAS]->(d), (t)-[:HAS_TYPE]->(y) 
RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL;
...
CREATE (vb)-[:HAS {relType: "HAS_BID" ,Date: LocalDateTime()}]->(b:Bid {BidCode: "B784981c5b0cc", Title: "Title of Bid for Tender 4 from Vendor 8", Description: "Description of Bid for Tender 4 from Vendor 8", Scope: "Scope of Bid for Tender 4 from Vendor 8", Deliverables: "List of deliverables of Bid for Tender 4 from Vendor 8", CompletitionDate:  LocalDateTime() + duration({day: 75}), Price: 75000, Conditions: "Vendor 8 Conditions for Bid of Tender 4", Qualifications: "Vendor 8 qualifications for Tender 4", SubmissionDate: LocalDateTime()})<-[:HAS {relType: "HAS_BID", Date: LocalDateTime()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(d:Doc {DocName: "BidDoc T4-V8", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFQDocT4_V8_01.pdf", Description: "This is the description of the Bid RFQ Document", Date: LocalDateTime()}),
       (b)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "Tender 4 is now officially Closed for bidding. We will communicate the results as soon as we have an awarded bid. Thanks for participating."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m1:Message {Text: "Hi, I have a question about the bid. Can you please justify the price and delivery dates?"})-[:SENT_BY]->(e);

MATCH (vc:VendorContact)<-[:HAS_CONTACT]-(v:Vendor)<-[:HAS_VENDOR]-(b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c)
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m2:Message {Text: "Hi Albert. Sure, the price is 80000 given the complexity of the project. As we will need to bring extra resources and might have to hire a few new resources, the timeframe might be a bit longer than usual. Is there anything else you need?"})-[:SENT_BY]->(vc);

MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c), (e:Employee {Name: "Albert"})  
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m3:Message {Text: "Thanks, Herbert. No, that will be all. Thank you!"})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m4:Message {Text: "Hi Herbert, this is Gloria from the Approval team and I would like to know how committed you are for delivering on the proposed time?"})-[:SENT_BY]->(l1);

// The Vendor 7 contact person will reply to Gloria's question
MATCH (vc:VendorContact)<-[:HAS_CONTACT]-(v:Vendor)<-[:HAS_VENDOR]-(b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c)
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m5:Message {Text: "Hi Gloria, we are fully committed to delivering on the proposed time. We have the resources and the expertise to deliver on time. Is there anything else you need?"})-[:SENT_BY]->(vc);

// Gloria thanks the Vendor 7 contact person for the reply
MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_CHAT]->(c), (l1:Employee {Name: "Gloria"})  
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m6:Message {Text: "Thanks Herbert, that will be all from my side. Thanks!"})-[:SENT_BY]->(l1);
...
WITH b 
CREATE (b)-[:HAS_AI_AGENT_ASSESMENT {Date: LocalDateTime()}]->(:AIBidAssesment {Rating: rand(), 
AssessmentSummary: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ornare id justo ac varius. Aliquam in dui consequat, pulvinar lorem quis, rhoncus ipsum. Aenean mi dolor, dapibus ac urna eget, condimentum facilisis urna. Sed vulputate fermentum odio, ut mattis magna rhoncus sit amet. Morbi vestibulum tortor et diam placerat, et tristique mauris porta. Sed tellus diam, aliquam ac ullamcorper malesuada, iaculis nec sem. Mauris felis risus, fringilla in pellentesque a, porta eget arcu. Proin id leo eu tortor dapibus pellentesque at eget justo. Nunc quis euismod erat. Nullam non interdum nibh. Sed ipsum erat, feugiat quis mauris et, tempor laoreet nulla. Duis tincidunt dolor a tortor accumsan, vitae eleifend est efficitur. Suspendisse efficitur, justo non malesuada feugiat, leo enim tincidunt tortor, non tempor nunc magna at purus.", 
Advantages: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer blandit auctor sem, ut pharetra erat mollis id. Vestibulum eu mi venenatis, lacinia orci nec, laoreet diam. Maecenas auctor ac ante eu vestibulum. Sed vitae placerat ex, sed pharetra ex. Donec pharetra mi lacus. Etiam et dapibus erat, a mattis diam. Pellentesque rhoncus tellus ac sem pellentesque laoreet. Sed accumsan maximus odio sed molestie.", 
Disadvantages: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla bibendum elementum tristique. Fusce neque nisl, fermentum eget tellus elementum, semper consectetur dui. Morbi eros arcu, vehicula ac magna ut, lacinia ornare felis. Integer tincidunt mi vel dolor convallis pharetra. Cras viverra congue nisi et imperdiet. In posuere vehicula commodo. Ut viverra sapien arcu, vel maximus leo feugiat non."});
...
CREATE (b)-[:HAS_BID_REQUESTER_APPROVAL {Date: LocalDateTime(), Comment: "This bid is approved"}]->(e);
...
CREATE (b)-[:HAS_L1_REJECTION {Date: LocalDateTime(), Comment: "This bid is rejected by L1"}]->(l1);
...
CREATE (b)-[:HAS_L1_APPROVAL {Date: LocalDateTime(), Comment: "This bid is approved"}]->(l1);
...
CREATE (b)-[:HAS_L2_APPROVAL {Date: LocalDateTime(), Comment: "This bid is approved"}]->(l2);
...
CREATE  (b)-[:HAS_L3_APPROVAL {Date: LocalDateTime(), Comment: "This bid is approved"}]->(l3),
        (aw)-[:HAS {relType: "IS_TENDER_STATE"}]->(t),
        (t)-[:HAS_AWARDED_VENDOR {Date: LocalDateTime()}]->(v), // This relationship is redundant (optional), as the Bid already has a relationship with the Vendor, but it is kept for clarity and future reference.
        (t)-[:HAS_AWARDED_BID {Date: LocalDateTime()}] ->(b)
 DELETE r1;
...
CREATE (ab)-[:HAS {relType: "HAS_AWARDED_BID"}]->(b)
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "Congratulations! The Bid for Tender 1 has been awarded to you! We look forward for to starting the Project as soon as possible."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "The Bid for Tender 1 has not been awarded to you. We thank you for your participation and look forward to working with you in the future."})-[:SENT_BY]->(e);
...
CREATE (pb)-[:HAS  {relType: "HAS_PAST_BID"}]->(b) 
DELETE r1, r2;
...
MATCH (em:Employee {Name: "Albert"}), (nt:NewTenderS {Name: "NewTenderS"}), (ty:TenderType {Name: "Open"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 10", Description: "This is the tenth tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 20}) , Budget: 100000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_10_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPDocument_t10.pdf", Description: "This is the Tender 10 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_10_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender10/RFPResponseTemplate-t10.pdf", Description: "This is the Tender 10 RFP mandatory response template", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_10_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender10/RFPPresentation_t10.pdf", Description: "This is the Tender 10 RFP Presentation", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Brandon"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Selective"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 11", Description: "This is the eleventh tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 500000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_11_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brandon/Tender11/RFPDocument_t11.pdf", Description: "This is the Tender 11 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_11_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brndon/Tender11/RFPResponseTemplate-t11.pdf", Description: "This is the Tender 11 RFP mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Charles"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Negotiated"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 12", Description: "This is the twelvth tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 45}) , Budget: 1300000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_12_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPDocument_t12.pdf", Description: "This is the Tender 12 RFP Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_12_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPResponseTemplate-t12.pdf", Description: "This is the Tender 12 RFP mandatory response template", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_12_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPPresentation_t12.pdf", Description: "This is the Tender 12 RFP Presentation", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Donald"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Open"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 13", Description: "This is the thirteenth tender for testing purposes", SubmissionDate: LocalDateTime(), EndBidingDate: LocalDateTime() + duration({day: 30}) , Budget: 70000 })<-[:HAS {relType:"IS_TENDER_STATE"}]-(nt),
         (t1)-[:HAS_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_13_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender13/RFQDocument_t13.pdf", Description: "This is the Tender 13 RFQ Document", Date: LocalDateTime()}),
         (d)-[:HAS {relType:"HAS_DOCUMENT"}]->(:Doc {DocName: "Tender_13_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender13/RFQResponseTemplate-t13.pdf", Description: "This is the Tender 13 RFQ mandatory response template", Date: LocalDateTime()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:HAS_TYPE]->(ty),
         (t1)-[:HAS_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 10)."})-[:SENT_BY]->(e);
...
CREATE (c)-[:HAS {relType:"HAS_MESSAGE", Date: LocalDateTime()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 12)."})-[:SENT_BY]->(e);
