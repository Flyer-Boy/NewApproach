...
// This v7 introduces changes of truly *ontological* proportions.
...
// To maintain some level of Ontology, I had added a property called RelType on the
...
// In v7, I removed the common [:HAS] relationship type entirely and adopted
...
// And.. I fixed some typos and bugs and minor improvements here and there.
...
//
// !! The script illustrates how Graphs can serve as both the DATA LAYER and the EXECUTION ENGINE/LOGIC/CONTEXT LAYER for business applications, enabling a more intuitive and efficient development process. !!
...
//    Providing mathematical clarity, LLM interpretation/reasoning
...
DROP CONSTRAINT unique_EmployeeDirectorY IF EXISTS;
...
CREATE (t:TenderS {Name: "TenderS"})-[:HAS_NEW_TENDER_STATE]->(:NewTenderS {Name: "NewTenderS"}),
       (t)-[:HAS_APPROVED_TENDER_STATE]->(:ApprovedTenderS {Name: "ApprovedTenderS"}),
       (t)-[:HAS_REJECTED_TENDER_STATE]->(:RejectedTenderS {Name: "RejectedTenderS"}),
       (t)-[:HAS_PUBLISHED_TENDER_STATE]->(:PublishedTenderS {Name: "PublishedTenderS"}),
       (t)-[:HAS_AWARDED_TENDER_STATE]->(:AwardedTenderS {Name: "AwardedTenderS"}),
       (t)-[:HAS_CLOSED_TENDER_STATE]->(:ClosedTenderS {Name: "ClosedTenderS"});
...
CREATE (ty:TenderTypeS {Name: "TenderTypeS"})-[:HAS_TENDER_TYPE]->(:TenderType {Name: "Open", Description: "Open Tender", Rules: "Open to all vendors"}),
         (ty)-[:HAS_TENDER_TYPE]->(:TenderType {Name: "Selective", Description: "Selective Tender", Rules: "Only selected vendors can bid"}),
         (ty)-[:HAS_TENDER_TYPE]->(:TenderType {Name: "Negotiated", Description: "Negotiated Tender", Rules: "Negotiation with selected vendors"}),
         (ty)-[:HAS_TENDER_TYPE]->(:TenderType {Name: "Framework", Description: "Framework Tender", Rules: "Long-term agreement with selected vendors"}),
         (ty)-[:HAS_TENDER_TYPE]->(:TenderType {Name: "DirectAward", Description: "Direct Award Tender", Rules: "Directly awarded to a vendor without bidding"});
...
CREATE CONSTRAINT unique_EmployeeDirectorY IF NOT EXISTS
FOR (e:EmployeeDirectorY)
...
CREATE (r:RoleS {Name: "RoleS"})-[:HAS_ROLE_TYPE]->(:RolE {Name: "Requester", Description: "Tender Requester", Rules: "Requests Tenders"}),
       (r)-[:HAS_ROLE_TYPE]->(:RolE {Name: "VendorApprover", Description: "Vendor Approver", Rules: "Approves Vendors in the System"}),
       (r)-[:HAS_ROLE_TYPE]->(:RolE {Name: "Level1Approver", ApprovalBase: 0, ApprovalLimit: 200000, Description: "Level 1 Approver", Rules: "Approves Tenders with a Budget < 200000"}),
       (r)-[:HAS_ROLE_TYPE]->(:RolE {Name: "Level2Approver", ApprovalBase: 200001, ApprovalLimit: 300000, Description: "Level 2 Approver", Rules: "Approves Tenders with a Budget < 300000"}),
       (r)-[:HAS_ROLE_TYPE]->(:RolE {Name: "Level3Approver", ApprovalBase: 300001,ApprovalLimit: 2000000, Description: "Level 3 Approver", Rules: "Approves Tenders with a Budget < 2000000"}),
       (r)-[:HAS_ROLE_TYPE]->(:RolE {Name: "Publisher" , Description: "Publisher", Rules: "Publishes Tenders"});
...
// All employees that are elements of a given RolE Collection "(:RolE {Name:"Requester"})-[:IS_ACTIVE_ROLE]->(:Employee)" will have that Role. 
...
CREATE (v:VendorS {Name: "VendorS"})-[:HAS_VENDOR_PENDING_STATE]->(:PendingVendorS {Name: "PendingVendorS"}),
       (v)-[:HAS_VENDOR_APPROVED_STATE]->(:ApprovedVendorS {Name: "ApprovedVendorS"}),
       (v)-[:HAS_VENDOR_REJECTED_STATE]->(:RejectedVendorS {Name: "RejectedVendorS"});
...
CREATE  (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e1:Employee {Name: "Albert", ID: "S12345678N", Phone: "443344331", Email: "Albert@email.com" , Photo: "/src/assets/images/People/4139948.png" })<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq),
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e2:Employee {Name: "Brandon", ID: "S84765968N", Phone: "944453321", Email: "Brandon@email.com" , Photo: "/src/assets/images/People/4139993.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq), 
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e3:Employee {Name: "Charles", ID: "S324538736N", Phone: "997766544", Email: "Charles@email.com" , Photo: "/src/assets/images/People/4140050.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq), 
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e4:Employee {Name: "Donald", ID: "S67828333N",  Phone: "944455541", Email: "Donald@email.com" , Photo: "/src/assets/images/People/4140057.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}] -(rq),  
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e5:Employee {Name: "Eduard", ID: "S98376432N",  Phone: "955445551", Email: "Eduard@email.com" , Photo: "/src/assets/images/People/4140037.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq), 
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e6:Employee {Name: "Fred", ID: "S25984432N",  Phone: "909876665", Email: "Fred@email.com" , Photo: "/src/assets/images/People/4139981.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq),  
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e7:Employee {Name: "Gilbert", ID: "S093983333N", Phone: "55446773", Email: "Gilbert@email.com" , Photo: "/src/assets/images/People/4140055.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq), 
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e8:Employee {Name: "Harold", ID: "S763663638N",  Phone: "484747443", Email: "Harold@email.com" , Photo: "/src/assets/images/People/4140063.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq), 
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e9:Employee {Name: "Ingrid", ID: "S18487473N",  Phone: "998474731", Email: "Ingrid@email.com" , Photo: "/src/assets/images/People/4140060.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq), 
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e10:Employee {Name: "Juliet", ID: "S17477328N",Phone: "998474744", Email: "Juliet@email.com" , Photo: "/src/assets/images/People/4140078.png" })<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq),
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e11:Employee {Name: "Keneth", ID: "T84735968N",  Phone: "9494453321", Email: "Keneth@email.com" , Photo: "/src/assets/images/People/6997675.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq),
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e12:Employee {Name: "Marlon", ID: "T324518736N", Phone: "9909136544", Email: "Marlon@email.com" , Photo: "/src/assets/images/People/4140050.png" })<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq),
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e13:Employee {Name: "Nelson", ID: "T67028333N", Phone: "9449851541", Email: "Nelson@email.com" , Photo: "/src/assets/images/People/4140057.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(rq);

MATCH (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (va:RolE {Name: "VendorApprover"})
CREATE  (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e14:Employee {Name: "Robert", ID: "T98846432N", Phone: "9551062551", Email: "Robert@email.com" , Photo: "/src/assets/images/People/4140037.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(va),
        (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e15:Employee {Name: "Mary", ID: "T25980932N", Phone: "909870092", Email: "Mary@email.com" , Photo: "/src/assets/images/People/4140076.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(va);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (l1:RolE {Name: "Level1Approver"})
CREATE  (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e16:Employee {Name: "Gloria", ID: "T093982633N", Phone: "559831373", Email: "Gloria@email.com" , Photo: "/src/assets/images/People/4140047.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(l1);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (l2:RolE {Name: "Level2Approver"})       
CREATE  (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e17:Employee {Name: "Sara", ID: "T763663208N", Phone: "4849810343", Email: "Sara@email.com" , Photo: "/src/assets/images/People/4143768.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(l2);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (l3:RolE {Name: "Level3Approver"})
CREATE  (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e18:Employee {Name: "Christine", ID: "T14987473N", Phone: "9998344731", Email: "Christine@email.com" , Photo: "/src/assets/images/People/4140071.png"})<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(l3);

MATCH   (ed:EmployeeDirectorY {Name: "EmployeeDirectorY"}), (p:RolE {Name: "Publisher"})
CREATE  (ed)-[:HAS_ACTIVE_EMPLOYEE]->(e19:Employee {Name: "Cloe", ID: "T17488328N", Phone: "998195044", Email: "Cloe@email.com" , Photo: "/src/assets/images/People/4140069.png" })<-[:IS_ACTIVE_ROLE {StartDate: datetime()}]-(p);
...
CREATE (ed)-[:HAS_ACTIVE_EMPLOYEE]->(:Employee {Name: "System", ID: "SYSTEM"});
...
// AI Agent Query: 
MATCH (:PendingVendorS {Name: "PendingVendorS"})-[:IS_VENDOR_STATE]->(v)-[:HAS_VENDOR_DOCS]->()-[:HAS_VENDOR_DOCUMENT]->(d:VendorDoc {DocName: "VendorRFIDoc"}) RETURN v.VendorCode, v.ShortName, d.URL;
...
MATCH (:PendingVendorS {Name: "PendingVendorS"})-[:IS_VENDOR_STATE]->(v)
WITH v 
CREATE (v)-[:HAS_AI_AGENT_VENDOR_ASSESSMENT {Date: localdatetime.transaction()}]->(:AIVendorAssessment {Rating: rand(), 
...
MATCH (:PendingVendorS {Name: "PendingVendorS"})-[:IS_VENDOR_STATE]->(v:Vendor)-[:HAS_AI_AGENT_VENDOR_ASSESSMENT {Date: localdatetime.transaction()}]->(ai:AIVendorAssessment), (v)-[:HAS_VENDOR_DOCS]->()-[:HAS_VENDOR_DOCUMENT]->(d:VendorDoc {DocName: "VendorRFIDoc"})
RETURN ai.Rating as AI_Rating, ai.AssessmentSummary as AI_Assessment, v.VendorCode, v.ShortName, v.LegalName, d.URL as Vendor_RFI_Response;
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:IS_VENDOR_STATE]->(v:Vendor {ShortName: "Vendor 1"}), (l1:Employee {Name: "Robert"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_VENDOR_APPROVAL {Date: localdatetime.transaction(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:IS_VENDOR_STATE]->(v),
       (v)-[:HAS_ACCEPTED_INVITATIONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:IS_VENDOR_STATE]->(v:Vendor {ShortName: "Vendor 3"}), (l1:Employee {Name: "Mary"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_VENDOR_APPROVAL {Date: localdatetime.transaction(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:IS_VENDOR_STATE]->(v),
       (v)-[:HAS_ACCEPTED_INVITATIONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:IS_VENDOR_STATE]->(v:Vendor {ShortName: "Vendor 4"}), (l1:Employee {Name: "Robert"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_VENDOR_APPROVAL {Date: localdatetime.transaction(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:IS_VENDOR_STATE]->(v),
       (v)-[:HAS_ACCEPTED_INVITATIONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:IS_VENDOR_STATE]->(v:Vendor {ShortName: "Vendor 7"}), (l1:Employee {Name: "Mary"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_VENDOR_APPROVAL {Date: localdatetime.transaction(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:IS_VENDOR_STATE]->(v),
       (v)-[:HAS_ACCEPTED_INVITATIONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:IS_VENDOR_STATE]->(v:Vendor {ShortName: "Vendor 8"}), (l1:Employee {Name: "Robert"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_VENDOR_APPROVAL {Date: localdatetime.transaction(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:IS_VENDOR_STATE]->(v),
       (v)-[:HAS_ACCEPTED_INVITATIONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:IS_VENDOR_STATE]->(v:Vendor {ShortName: "Vendor 10"}), (l1:Employee {Name: "Mary"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "VendorApprover"}), (av:ApprovedVendorS {Name: "ApprovedVendorS"})
CREATE (v)-[:HAS_L1_VENDOR_APPROVAL {Date: localdatetime.transaction(), Comment: "This vendor is approved"}]->(l1),
       (av)-[:IS_VENDOR_STATE]->(v),
       (v)-[:HAS_ACCEPTED_INVITATIONS]->(:AcceptedInvitationS {Name: "AcceptedInvitationS"}),
       (v)-[:HAS_ACTIVE_BIDS]->(:ActiveBidS {Name: "ActiveBidS"}),
...
MATCH (pv:PendingVendorS {Name: "PendingVendorS"})-[r1:IS_VENDOR_STATE]->(v:Vendor {ShortName: "Vendor 2"}), (l1:Employee {Name: "Robert"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "VendorApprover"}), (rv:RejectedVendorS {Name: "RejectedVendorS"}) 
CREATE (v)-[:HAS_L1_VENDOR_REJECTION {Date: localdatetime.transaction(), Comment: "This vendor is rejected"}]->(l1),
       (rv)-[:IS_VENDOR_STATE]->(v)
       DELETE r1;
...
MATCH (TenderTypeS {Name: "TenderTypeS"})-[:HAS_TENDER_TYPE]->(ty) RETURN ty.Name, ty.Description, ty.Rules;
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 1", Description: "This is the first tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 400000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_1_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPDocument_t1.pdf", Description: "This is the Tender 1 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_1_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPResponseTemplate-t1.pdf", Description: "This is the Tender 1 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_1_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPPresentation_t1.pdf", Description: "This is the Tender 1 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 2", Description: "This is the second tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 200000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_2_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brandon/Tender2/RFPDocument_t2.pdf", Description: "This is the Tender 2 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_2_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brndon/Tender2/RFPResponseTemplate-t2.pdf", Description: "This is the Tender 2 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 3", Description: "This is the third tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 300000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_3_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPDocument_t3.pdf", Description: "This is the Tender 3 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_3_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPResponseTemplate-t3.pdf", Description: "This is the Tender 3 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_3_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender3/RFPPresentation_t3.pdf", Description: "This is the Tender 3 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 4", Description: "This is the third tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 40000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_4_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender4/RFQDocument_t4.pdf", Description: "This is the Tender 4 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_4_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender4/RFQResponseTemplate-t4.pdf", Description: "This is the Tender 4 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 5", Description: "This is the fifth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 200000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_5_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Eduard/Tender5/RFPDocument_t5.pdf", Description: "This is the Tender 5 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_5_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Eduard/Tender5/RFPResponseTemplate-t5.pdf", Description: "This is the Tender 5 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 6", Description: "This is the sixth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 300000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_6_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Fred/Tender6/RFPDocument_t6.pdf", Description: "This is the Tender 6 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_6_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Fred/Tender6/RFPResponseTemplate-t6.pdf", Description: "This is the Tender 6 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 7", Description: "This is the seventh tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 400000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_7_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Gilbert/Tender7/RFPDocument_t7.pdf", Description: "This is the Tender 7 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_7_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Gilbert/Tender7/RFPResponseTemplate-t7.pdf", Description: "This is the Tender 7 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 8", Description: "This is the Tender 8 for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 100000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_8_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Harold/Tender8/RFQDocument_t8.pdf", Description: "This is the Tender 8 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_8_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Harold/Tender8/RFQResponseTemplate-t8.pdf", Description: "This is the Tender 8 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});      
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 9", Description: "This is the tenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 180000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_9_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9/RFQDocument_t9.pdf", Description: "This is the Tender 9 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_9_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9/RFQResponseTemplate-t9.pdf", Description: "This is the Tender 9 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (t:Tender {Title: "Tender 1"})-[:HAS_TENDER_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi, I have a question about the tender. Can you please clarify the budget?"})-[:SENT_BY]->(l1);

MATCH (e:Employee)<-[:HAS_REQUESTER]-(t:Tender {Title: "Tender 1"})-[:HAS_TENDER_CHAT]->(c) 
CREATE  (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m2:Message {Text: "Sure, the budget is 400000 in order to include the international deployment as discussed on the meeting of March 10th. Is there anything else you need?"})-[:SENT_BY]->(e);

MATCH (t:Tender {Title: "Tender 1"})-[:HAS_TENDER_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m3:Message {Text: "No, that will be all. Thank you!"})-[:SENT_BY]->(l1);           
...
MATCH (t:Tender {Title: "Tender 1"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1);
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[:IS_NEW_TENDER_STATE]->(t:Tender) 
...
MATCH (t:Tender {Title: "Tender 1"}), (l2:Employee {Name: "Sara"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level2Approver"})
CREATE (t)-[:HAS_L2_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l2);
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[:IS_NEW_TENDER_STATE]->(t:Tender) 
WHERE NOT (t)-[:HAS_L3_TENDER_APPROVAL]->(:Employee) AND t.Budget >= 300000 AND (t)-[:HAS_L2_TENDER_APPROVAL]->()
AND NOT (t)-[:HAS_L3_TENDER_APPROVAL]->(:Employee)              
RETURN t.Title, t.TenderCode, t.Description, t.SubmissionDate, t.EndBidingDate, t.Budget;
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 1"}), (l3:Employee {Name: "Christine"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level3Approver"}), (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L3_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l3),
...
MATCH (t:Tender {Title: "Tender 2"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1);
...
MATCH (t:Tender {Title: "Tender 2"})-[:HAS_TENDER_CHAT]->(c), (l2:Employee {Name: "Sara"}) 
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi, I have a question about the tender. Can you please clarify the criteria for selecting the 2 vendors?"})-[:SENT_BY]->(l2);

// Let's have the Tender 2 Requester (Brandon) answer the question from Approver 2 (Sara).
MATCH (e:Employee)<-[:HAS_REQUESTER]-(t:Tender {Title: "Tender 2"})-[:HAS_TENDER_CHAT]->(c)                
CREATE  (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m2:Message {Text: "Sure, the criteria are based on the vendors experience and the price they offered in previous tenders. Is there anything else you need?"})-[:SENT_BY]->(e);

// Let's have the Approver 2 (Sara) Reply.
MATCH (t:Tender {Title: "Tender 2"})-[:HAS_TENDER_CHAT]->(c), (l2:Employee {Name: "Sara"}) 
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m3:Message {Text: "No, that will be all. Thank you!"})-[:SENT_BY]->(l2);



// ------ Tender #3 Approval
// Let's have the L1 approver (Gloria) approve the Tender 3 
MATCH (t:Tender {Title: "Tender 3"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1);

// Let’s have the L2 approver (Sara) approve the Tender 3
MATCH (t:Tender {Title: "Tender 3"}), (l2:Employee {Name: "Sara"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level2Approver"})
CREATE (t)-[:HAS_L2_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l2);
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 3"}), (l3:Employee {Name: "Christine"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level3Approver"}), (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L3_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l3),
       (at)-[:IS_APPROVED_TENDER_STATE]->(t)
DELETE r1;
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 4"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"}),  (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1),
       (at)-[:IS_APPROVED_TENDER_STATE]->(t)
DELETE r1;  
...
// ------ Tender #5 Approval
// Let's have the L1 approver (Gloria) approve the Tender 3 
MATCH (t:Tender {Title: "Tender 5"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1);

// Let’s have the L2 approver (Sara) approve the Tender 3
MATCH (t:Tender {Title: "Tender 5"}), (l2:Employee {Name: "Sara"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level2Approver"})
CREATE (t)-[:HAS_L2_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l2);


// Let's have the L3 approver (Christine) approve the Tender 3, and as the L3 is the final approver, let's move the Tender to the ApprovedTenderS Collection and remove it from the NewTenderS Collection
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 5"}), (l3:Employee {Name: "Christine"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level3Approver"}), (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L3_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l3),
       (at)-[:IS_APPROVED_TENDER_STATE]->(t)
DELETE r1;
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 8"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"}),  (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1),
       (at)-[:IS_APPROVED_TENDER_STATE]->(t)
DELETE r1;
...
MATCH (t:Tender {Title: "Tender 9"})-[:HAS_TENDER_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi Ingrid, I have a question about the tender. Reading thrugh the documentation, it seems that this Tender is not complient with our Tender norms as per Schedule 11?"})-[:SENT_BY]->(l1);

MATCH (e:Employee)<-[:HAS_REQUESTER]-(t:Tender {Title: "Tender 9"})-[:HAS_TENDER_CHAT]->(c) 
CREATE  (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m2:Message {Text: "Opps, my bad! You are right. We overlooked this part. Sorry"})-[:SENT_BY]->(e);

MATCH (t:Tender {Title: "Tender 9"})-[:HAS_TENDER_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m3:Message {Text: "No Proble. I will reject it. So if you are willing to move forward, fix the compliance parts and resubmit it. Thank you!"})-[:SENT_BY]->(l1);          

// Now the L1 approver (Gloria) is ready to reject Tender 9, as she has all the information she needs.
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 9"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"}), (rv:RejectedTenderS {Name: "RejectedTenderS"})
CREATE (t)-[:HAS_L1_TENDER_REJECTION {Date: localdatetime.transaction(), Comment: "This tender is rejected"}]->(l1),
...
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 9.1", Description: "This is the tenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 180000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_9_1_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9_1/RFQDocument_t9_1.pdf", Description: "This is the Tender 9.1 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_9_1_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Ingrid/Tender9_1/RFQResponseTemplate-t9_1.pdf", Description: "This is the Tender 9.1 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"}),
...
MATCH (at:ApprovedTenderS {Name: "ApprovedTenderS"})-[r1:IS_APPROVED_TENDER_STATE]->(t:Tender {Title: "Tender 1"}), (p:Employee {Name: "Cloe"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Publisher"}), (pt:PublishedTenderS {Name: "PublishedTenderS"})
CREATE (t)-[:HAS_PUBLISHER_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved for Publishing"}]->(p),
...
UNWIND COLLECT {MATCH (v:Vendor)<-[:IS_VENDOR_STATE]-(:ApprovedVendorS) RETURN v} AS vendor
        CREATE (iv)-[:HAS_INVITATION {Date: localdatetime.transaction()}]->(vendor);
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 1"})-[:HAS_INVITEES]->()-[:HAS_INVITATION]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE {Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 1)."})-[:SENT_BY]->(e);
...
// Now that we are publishing the Tender, we will also create the Tender's "InvitedVenrorS" collection to place the Vendors that will be invited and the TenderBidS collection
MATCH (at:ApprovedTenderS {Name: "ApprovedTenderS"})-[r1:IS_APPROVED_TENDER_STATE]->(t:Tender {Title: "Tender 3"}), (p:Employee {Name: "Cloe"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Publisher"}), (pt:PublishedTenderS {Name: "PublishedTenderS"})
CREATE (t)-[:HAS_PUBLISHER_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved for Publishing"}]->(p),
       (t)-[:HAS_INVITEES]->(:InvitedVendorS {Name: "InvitedVendorS"}),
       (t)-[:HAS_TENDER_BIDS]->(:TenderBidS {Name: "TenderBidS"}),
       (pt)-[:IS_PUBLISHED_TENDER_STATE]->(t)
...
MATCH (v:Vendor {ShortName: "Vendor 7"})<-[:IS_VENDOR_STATE]-(:ApprovedVendorS)
        CREATE (iv)-[:HAS_INVITATION {Date: localdatetime.transaction()}]->(v);
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 3"})-[:HAS_INVITEES]->()-[:HAS_INVITATION]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 3)."})-[:SENT_BY]->(e);
...
// Now that we are publishing the Tender, we will also create the Tender's "InvitedVenrorS" collection to place the Vendors that will be invited and the TenderBidS collection
MATCH (at:ApprovedTenderS {Name: "ApprovedTenderS"})-[r1:IS_APPROVED_TENDER_STATE]->(t:Tender {Title: "Tender 4"}), (p:Employee {Name: "Cloe"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Publisher"}), (pt:PublishedTenderS {Name: "PublishedTenderS"})
CREATE (t)-[:HAS_PUBLISHER_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved for Publishing"}]->(p),
       (t)-[:HAS_INVITEES]->(:InvitedVendorS {Name: "InvitedVendorS"}),
       (t)-[:HAS_TENDER_BIDS]->(:TenderBidS {Name: "TenderBidS"}),
       (pt)-[:IS_PUBLISHED_TENDER_STATE]->(t)
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 4"})-[:HAS_INVITEES]->()-[:HAS_INVITATION]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 4)."})-[:SENT_BY]->(e);
...
// Now that we are publishing the Tender, we will also create the Tender's "InvitedVenrorS" collection to place the Vendors that will be invited and the TenderBidS collection
MATCH (at:ApprovedTenderS {Name: "ApprovedTenderS"})-[r1:IS_APPROVED_TENDER_STATE]->(t:Tender {Title: "Tender 5"}), (p:Employee {Name: "Cloe"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Publisher"}), (pt:PublishedTenderS {Name: "PublishedTenderS"})
CREATE (t)-[:HAS_PUBLISHER_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved for Publishing"}]->(p),
       (t)-[:HAS_INVITEES]->(:InvitedVendorS {Name: "InvitedVendorS"}),
       (t)-[:HAS_TENDER_BIDS]->(:TenderBidS {Name: "TenderBidS"}),
       (pt)-[:IS_PUBLISHED_TENDER_STATE]->(t)
...
UNWIND COLLECT {MATCH (v:Vendor)<-[:IS_VENDOR_STATE]-(:ApprovedVendorS) ORDER BY v.ShortName DESC RETURN v LIMIT 2} AS vendor
        CREATE (iv)-[:HAS_INVITATION {Date: localdatetime.transaction()}]->(vendor);


// Now we must communicate all the Tender 5 invitees about their invitation so they can decide if they want to participat in the Tender.
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 5"})-[:HAS_INVITEES]->()-[:HAS_INVITATION]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 5)."})-[:SENT_BY]->(e);
...
MATCH (v:Vendor {ShortName: "Vendor 7"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender)<-[:IS_PUBLISHED_TENDER_STATE]-(:PublishedTenderS), (t)-[:IS_TENDER_TYPE]-(ty:TenderType) RETURN t.TenderCode, t.Title, t.Description, t.SubmissionDate, t.Budget, ty.Name;
...
MATCH (ti:AcceptedInvitationS {Name: "AcceptedInvitationS"})<-[:HAS_ACCEPTED_INVITATIONS]-(v:Vendor {ShortName: "Vendor 7"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender {Title: "Tender 1"})
CREATE (ti)-[:HAS_ACCEPTED_TENDER_INVITATION { Date: localdatetime.transaction()}]->(t);
...
MATCH (ti:AcceptedInvitationS {Name: "AcceptedInvitationS"})<-[:HAS_ACCEPTED_INVITATIONS]-(v:Vendor {ShortName: "Vendor 7"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender {Title: "Tender 3"})
CREATE (ti)-[:HAS_ACCEPTED_TENDER_INVITATION { Date: localdatetime.transaction()}]->(t);


// UI Query—First, Vendor 4 will check what Tenders have been published and whether they have been invited to bid.
MATCH (v:Vendor {ShortName: "Vendor 4"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender)<-[:IS_PUBLISHED_TENDER_STATE]-(:PublishedTenderS), (t)-[:IS_TENDER_TYPE]-(ty:TenderType) RETURN t.TenderCode, t.Title, t.Description, t.SubmissionDate, t.Budget, ty.Name;
...
MATCH (ti:AcceptedInvitationS {Name: "AcceptedInvitationS"})<-[:HAS_ACCEPTED_INVITATIONS]-(v:Vendor {ShortName: "Vendor 4"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender {Title: "Tender 1"})    
CREATE (ti)-[:HAS_ACCEPTED_TENDER_INVITATION { Date: localdatetime.transaction()}]->(t);


// UI Query—First, Vendor 3 will check what Tenders have been published and whether they have been invited to bid.
MATCH (v:Vendor {ShortName: "Vendor 3"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender)<-[:IS_PUBLISHED_TENDER_STATE]-(:PublishedTenderS), (t)-[:IS_TENDER_TYPE]-(ty:TenderType) RETURN t.TenderCode, t.Title, t.Description, t.SubmissionDate, t.Budget, ty.Name;
...
MATCH (ti:AcceptedInvitationS {Name: "AcceptedInvitationS"})<-[:HAS_ACCEPTED_INVITATIONS]-(v:Vendor {ShortName: "Vendor 3"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender {Title: "Tender 4"})    
CREATE (ti)-[:HAS_ACCEPTED_TENDER_INVITATION { Date: localdatetime.transaction()}]->(t);

//UI Query—First, Vendor 8 will check what Tenders have been published and whether they have been invited to bid.
MATCH (v:Vendor {ShortName: "Vendor 8"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender)<-[:IS_PUBLISHED_TENDER_STATE]-(:PublishedTenderS), (t)-[:IS_TENDER_TYPE]-(ty:TenderType) RETURN t.TenderCode, t.Title, t.Description, t.SubmissionDate, t.Budget, ty.Name;
...
MATCH (ti:AcceptedInvitationS {Name: "AcceptedInvitationS"})<-[:HAS_ACCEPTED_INVITATIONS]-(v:Vendor {ShortName: "Vendor 8"})<-[:HAS_INVITATION]-(:InvitedVendorS)<-[:HAS_INVITEES]-(t:Tender {Title: "Tender 4"})    
CREATE (ti)-[:HAS_ACCEPTED_TENDER_INVITATION { Date: localdatetime.transaction()}]->(t);
...
MATCH (v:Vendor {ShortName: "Vendor 7"})-[:HAS_ACCEPTED_INVITATIONS]->()-[:HAS_ACCEPTED_TENDER_INVITATION]->(t)-[:HAS_TENDER_DOCS]->()-[:HAS_TENDER_DOCUMENT]->(d), (t)-[:IS_TENDER_TYPE]->(y) RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL AS TenderDocURL;
...
CREATE (vb)-[:HAS_ACTIVE_BID {Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B79c69d9843ff", Title: "Title of Bid for Tender 1 from Vendor 7", Description: "Description of Bid for Tender 1 from Vendor 7", Scope: "Scope of Bid for Tender 1 from Vendor 7", Deliverables: "List of deliverables of Bid for Tender 1 from Vendor 7", CompletionDate:  localdatetime.transaction() + duration({days: 90}), Price: 80000, Conditions: "Vendor 7 Conditions for Bid of Tender 1", Qualifications: "Vendor 7 qualifications for Tender 1",  SubmissionDate: localdatetime.transaction()})<-[:HAS_TENDER_BID {Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_BID_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS_BID_DOCUMENT]->(d:BidDoc {DocName: "BidDoc T1-V7", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT1_V7_01.pdf", Description: "This is the description of the RFP Document", Date: localdatetime.transaction()}),
...
CREATE (vb)-[:HAS_ACTIVE_BID {Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Title of Bid for Tender 3 from Vendor 7", Description: "Description of Bid for Tender 3 from Vendor 7", Scope: "Scope of Bid for Tender 3 from Vendor 7", Deliverables: "List of deliverables of Bid for Tender 3 from Vendor 7", CompletionDate:  localdatetime.transaction() + duration({days: 160}), Price: 290000, Conditions: "Vendor 7 Conditions for Bid of Tender 3", Qualifications: "Vendor 7 qualifications for Tender 3", SubmissionDate: localdatetime.transaction()})<-[:HAS_TENDER_BID {Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_BID_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS_BID_DOCUMENT]->(d:BidDoc {DocName: "BidDoc T3-V7", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT3_V7_01.pdf", Description: "This is the description of the RFP Document", Date: localdatetime.transaction()}),
       (b)-[:HAS_BID_CHAT]->(:ConversatioN {Name: "ConversatioN"});                                 
...
MATCH (v:Vendor {ShortName: "Vendor 4"})-[:HAS_ACCEPTED_INVITATIONS]->()-[:HAS_ACCEPTED_TENDER_INVITATION]->(t)-[:HAS_TENDER_DOCS]->()-[:HAS_TENDER_DOCUMENT]->(d), (t)-[:IS_TENDER_TYPE]->(y) RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL AS TenderDocURL;
...
CREATE (vb)-[:HAS_ACTIVE_BID {Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Title of Bid for Tender 1 from Vendor 4", Description: "Description of Bid for Tender 1 from Vendor 4", Scope: "Scope of Bid for Tender 1 from Vendor 4", Deliverables: "List of deliverables of Bid for Tender 1 from Vendor 4", CompletionDate:  localdatetime.transaction() + duration({days: 75}), Price: 75000, Conditions: "Vendor 4 Conditions for Bid of Tender 1", Qualifications: "Vendor 4 qualifications for Tender 1", SubmissionDate: localdatetime.transaction()})<-[:HAS_TENDER_BID {Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_BID_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS_BID_DOCUMENT]->(d:BidDoc {DocName: "BidDoc T1-V4", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFPDocT1_V4_01.pdf", Description: "This is the description of the RFP Document", Date: localdatetime.transaction()}),
       (b)-[:HAS_BID_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (v:Vendor {ShortName: "Vendor 3"})-[:HAS_ACCEPTED_INVITATIONS]->()-[:HAS_ACCEPTED_TENDER_INVITATION]->(t)-[:HAS_TENDER_DOCS]->()-[:HAS_TENDER_DOCUMENT]->(d), (t)-[:IS_TENDER_TYPE]->(y) RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL AS TenderDocURL;
...
CREATE (vb)-[:HAS_ACTIVE_BID {Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Title of Bid for Tender 4 from Vendor 3", Description: "Description of Bid for Tender 4 from Vendor 3", Scope: "Scope of Bid for Tender 4 from Vendor 3", Deliverables: "List of deliverables of Bid for Tender 4 from Vendor 3", CompletionDate:  localdatetime.transaction() + duration({days: 75}), Price: 75000, Conditions: "Vendor 3 Conditions for Bid of Tender 4", Qualifications: "Vendor 3 qualifications for Tender 4", SubmissionDate: localdatetime.transaction()})<-[:HAS_TENDER_BID {Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_BID_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS_BID_DOCUMENT]->(d:BidDoc {DocName: "BidDoc T4-V3", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFQDocT4_V3_01.pdf", Description: "This is the description of the Bid RFQ Document", Date: localdatetime.transaction()}),
       (b)-[:HAS_BID_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (v:Vendor {ShortName: "Vendor 8"})-[:HAS_ACCEPTED_INVITATIONS]->()-[:HAS_ACCEPTED_TENDER_INVITATION]->(t)-[:HAS_TENDER_DOCS]->()-[:HAS_TENDER_DOCUMENT]->(d), (t)-[:IS_TENDER_TYPE]->(y) RETURN  t.TenderCode, t.Description, t.Budget, y.Name, d.URL AS TenderDocURL;
...
CREATE (vb)-[:HAS_ACTIVE_BID {Date: localdatetime.transaction()}]->(b:Bid {BidCode: "B784981c5b0cc", Title: "Title of Bid for Tender 4 from Vendor 8", Description: "Description of Bid for Tender 4 from Vendor 8", Scope: "Scope of Bid for Tender 4 from Vendor 8", Deliverables: "List of deliverables of Bid for Tender 4 from Vendor 8", CompletionDate:  localdatetime.transaction() + duration({days: 75}), Price: 75000, Conditions: "Vendor 8 Conditions for Bid of Tender 4", Qualifications: "Vendor 8 qualifications for Tender 4", SubmissionDate: localdatetime.transaction()})<-[:HAS_TENDER_BID {Date: localdatetime.transaction()}]-(tb),
       (b)-[:HAS_VENDOR]->(v),
       (b)-[:HAS_TENDER]->(t),
       (b)-[:HAS_BID_DOCS]->(:BidDocS {Name: "BidDocS"})-[:HAS_BID_DOCUMENT]->(d:BidDoc {DocName: "BidDoc T4-V8", Type: "PDF", URL: "https://docs.google.com/document/d/Vendor7/Tender1/Bid_RFQDocT4_V8_01.pdf", Description: "This is the description of the Bid RFQ Document", Date: localdatetime.transaction()}),
       (b)-[:HAS_BID_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 1"})<-[:HAS_ACCEPTED_TENDER_INVITATION]-(:AcceptedInvitationS)-[:HAS_ACCEPTED_INVITATIONS]-(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "Tender 4 is now officially Closed for bidding. We will communicate the results as soon as we have an awarded bid. Thanks for participating."})-[:SENT_BY]->(e);
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 3"})<-[:HAS_ACCEPTED_TENDER_INVITATION]-(:AcceptedInvitationS)-[:HAS_ACCEPTED_INVITATIONS]-(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "Tender 4 is now officially Closed for bidding. We will communicate the results as soon as we have an awarded bid. Thanks for participating."})-[:SENT_BY]->(e);
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 4"})<-[:HAS_ACCEPTED_TENDER_INVITATION]-(:AcceptedInvitationS)-[:HAS_ACCEPTED_INVITATIONS]-(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "Tender 4 is now officially Closed for bidding. We will communicate the results as soon as we have an awarded bid. Thanks for participating."})-[:SENT_BY]->(e);
...
MATCH (:PublishedTenderS)-[:IS_PUBLISHED_TENDER_STATE]->(t:Tender)<-[:HAS_TENDER]-(b:Bid)-[:HAS_VENDOR]->(v), (b)-[:HAS_BID_DOCS]->(:BidDocS)-[:HAS_BID_DOCUMENT]->(d:BidDoc)
RETURN t.TenderCode, t.Title, v.ShortName, b.BidCode, b.Title, b.Description, b.Scope, b.Deliverables, b.CompletionDate, b.Price, b.Conditions, b.Qualifications, b.SubmissionDate, d.DocName, d.URL;
...
MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_BID_CHAT]->(c), (e:Employee {Name: "Albert"})
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m1:Message {Text: "Hi, I have a question about the bid. Can you please justify the price and delivery dates?"})-[:SENT_BY]->(e);

MATCH (vc:VendorContact)<-[:HAS_CONTACT]-(v:Vendor)<-[:HAS_VENDOR]-(b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_BID_CHAT]->(c)
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m2:Message {Text: "Hi Albert. Sure, the price is 80000 given the complexity of the project. As we will need to bring extra resources and might have to hire a few new resources, the timeframe might be a bit longer than usual. Is there anything else you need?"})-[:SENT_BY]->(vc);

MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_BID_CHAT]->(c), (e:Employee {Name: "Albert"})  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m3:Message {Text: "Thanks, Herbert. No, that will be all. Thank you!"})-[:SENT_BY]->(e);

// Now, Gloria (the L1 Approver) will also ask a question about the Bid 1 of Tender 1 
MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_BID_CHAT]->(c), (l1:Employee {Name: "Gloria"})
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m4:Message {Text: "Hi Herbert, this is Gloria from the Approval team and I would like to know how committed you are for delivering on the proposed time?"})-[:SENT_BY]->(l1);

// The Vendor 7 contact person will reply to Gloria's question
MATCH (vc:VendorContact)<-[:HAS_CONTACT]-(v:Vendor)<-[:HAS_VENDOR]-(b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_BID_CHAT]->(c)
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m5:Message {Text: "Hi Gloria, we are fully committed to delivering on the proposed time. We have the resources and the expertise to deliver on time. Is there anything else you need?"})-[:SENT_BY]->(vc);

// Gloria thanks the Vendor 7 contact person for the reply
MATCH (b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_BID_CHAT]->(c), (l1:Employee {Name: "Gloria"})  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m6:Message {Text: "Thanks Herbert, that will be all from my side. Thanks!"})-[:SENT_BY]->(l1);
...
MATCH (:PublishedTenderS)-[:IS_PUBLISHED_TENDER_STATE]->(t)-[:HAS_TENDER_DOCS]->()-[:HAS_TENDER_DOCUMENT]->(d) RETURN t.TenderCode, d.URL AS TenderDocumentURL;

// The Vendor bid documents (RFQ/RFP templates filled) and any other documents submitted by the Vendor with the bid  
MATCH (:PublishedTenderS)-[:IS_PUBLISHED_TENDER_STATE]->(t)-[:HAS_TENDER_BIDS]->()-[:HAS_TENDER_BID]->(b)-[:HAS_BID_DOCS]->()-[:HAS_BID_DOCUMENT]->(d), (b)-[:HAS_VENDOR]-(v) RETURN t.TenderCode, v.VendorCode, b.BidCode, d.URL AS BidDocumentURL;

// All communications regarding the bid between the Tender team and the Vendor.
MATCH (:PublishedTenderS)-[:IS_PUBLISHED_TENDER_STATE]->(t)-[:HAS_TENDER_BIDS]->()-[:HAS_TENDER_BID]->(b)-[:HAS_BID_CHAT]->()-[r:HAS_MESSAGE]->(c)-[:SENT_BY]-(p) RETURN t.TenderCode, b.BidCode, p.Name, c.Text as BidChatMessage, r.Date as MessageDate ORDER by r.Date; 
...
MATCH (:PublishedTenderS)-[:IS_PUBLISHED_TENDER_STATE]->(t)-[:HAS_TENDER_BIDS]->()-[:HAS_TENDER_BID]->(b)
WITH b 
CREATE (b)-[:HAS_AI_AGENT_BID_ASSESSMENT {Date: localdatetime.transaction()}]->(:AIBidAssessment {Rating: rand(), 
AssessmentSummary: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ornare id justo ac varius. Aliquam in dui consequat, pulvinar lorem quis, rhoncus ipsum. Aenean mi dolor, dapibus ac urna eget, condimentum facilisis urna. Sed vulputate fermentum odio, ut mattis magna rhoncus sit amet. Morbi vestibulum tortor et diam placerat, et tristique mauris porta. Sed tellus diam, aliquam ac ullamcorper malesuada, iaculis nec sem. Mauris felis risus, fringilla in pellentesque a, porta eget arcu. Proin id leo eu tortor dapibus pellentesque at eget justo. Nunc quis euismod erat. Nullam non interdum nibh. Sed ipsum erat, feugiat quis mauris et, tempor laoreet nulla. Duis tincidunt dolor a tortor accumsan, vitae eleifend est efficitur. Suspendisse efficitur, justo non malesuada feugiat, leo enim tincidunt tortor, non tempor nunc magna at purus.", 
Advantages: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer blandit auctor sem, ut pharetra erat mollis id. Vestibulum eu mi venenatis, lacinia orci nec, laoreet diam. Maecenas auctor ac ante eu vestibulum. Sed vitae placerat ex, sed pharetra ex. Donec pharetra mi lacus. Etiam et dapibus erat, a mattis diam. Pellentesque rhoncus tellus ac sem pellentesque laoreet. Sed accumsan maximus odio sed molestie.", 
Disadvantages: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla bibendum elementum tristique. Fusce neque nisl, fermentum eget tellus elementum, semper consectetur dui. Morbi eros arcu, vehicula ac magna ut, lacinia ornare felis. Integer tincidunt mi vel dolor convallis pharetra. Cras viverra congue nisi et imperdiet. In posuere vehicula commodo. Ut viverra sapien arcu, vel maximus leo feugiat non."});
...
CREATE (b)-[:HAS_L1_TENDER_REJECTION {Date: localdatetime.transaction(), Comment: "This bid is rejected by L1"}]->(l1);
...
CREATE (b)-[:HAS_L1_BID_APPROVAL {Date: localdatetime.transaction(), Comment: "This bid is approved"}]->(l1);
...
CREATE (b)-[:HAS_L2_BID_APPROVAL {Date: localdatetime.transaction(), Comment: "This bid is approved"}]->(l2);
...
(l3:Employee {Name: "Christine"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level3Approver"}), (aw:AwardedTenderS {Name: "AwardedTenderS"})
CREATE  (b)-[:HAS_L3_BID_APPROVAL {Date: localdatetime.transaction(), Comment: "This bid is approved"}]->(l3),
        (aw)-[:IS_AWARDED_TENDER_STATE]->(t),
        (t)-[:IS_AWARDED_VENDOR {Date: localdatetime.transaction()}]->(v), // This relationship is redundant (optional), as the Bid already has a relationship with the Vendor, but it is kept for clarity and future reference.
        (t)-[:IS_AWARDED_BID {Date: localdatetime.transaction()}] ->(b)
 DELETE r1;
...
MATCH  (aw:AwardedTenderS {Name: "AwardedTenderS"})-[:IS_AWARDED_TENDER_STATE]->(t)<-[:HAS_TENDER]-(b:Bid {BidCode: "B79c69d9843ff"})<-[r1:HAS_ACTIVE_BID]-(:ActiveBidS)<-[:HAS_ACTIVE_BIDS]-(v)-[:HAS_AWARDED_BIDS]->(ab)
...
MATCH  (e:Employee {Name: "System"}), (aw:AwardedTenderS {Name: "AwardedTenderS"})-[:IS_AWARDED_TENDER_STATE]->(t)<-[:HAS_TENDER]-(b:Bid {BidCode: "B79c69d9843ff"})-[:HAS_VENDOR]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "Congratulations! The Bid for Tender 1 has been awarded to you! We look forward for to starting the Project as soon as possible."})-[:SENT_BY]->(e);
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 1"})-[:HAS_TENDER_BIDS]->(:TenderBidS)-[:HAS_TENDER_BID]->(b)-[:HAS_VENDOR]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN) WHERE NOT (t)-[:IS_AWARDED_BID]->(b)
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "The Bid for Tender 1 has not been awarded to you. We thank you for your participation and look forward to working with you in the future."})-[:SENT_BY]->(e);

// We will also move the Bids from these vendors from ActiveBids to their respective PastBids Collection so that they can have them on record.
...
MATCH (t:Tender {Title: "Tender 1"})-[:HAS_TENDER_BIDS]->(:TenderBidS)-[:HAS_TENDER_BID]->(b)<-[r1:HAS_ACTIVE_BID]-(ab)<-[:HAS_ACTIVE_BIDS]-(v)-[:HAS_PAST_BIDS]->(pb) WHERE NOT (t)-[:IS_AWARDED_BID]->(b)
WITH t , v , r1 , b, pb
MATCH (v)-[:HAS_ACCEPTED_INVITATIONS]->(ai)-[r2:HAS_ACCEPTED_TENDER_INVITATION]-(t) 
...
MATCH (em:Employee {Name: "Albert"}), (nt:NewTenderS {Name: "NewTenderS"}), (ty:TenderType {Name: "Open"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 10", Description: "This is the tenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 20}) , Budget: 100000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_10_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender1/RFPDocument_t10.pdf", Description: "This is the Tender 10 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_10_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender10/RFPResponseTemplate-t10.pdf", Description: "This is the Tender 10 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_10_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Albert/Tender10/RFPPresentation_t10.pdf", Description: "This is the Tender 10 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Brandon"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Selective"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 11", Description: "This is the eleventh tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 500000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_11_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brandon/Tender11/RFPDocument_t11.pdf", Description: "This is the Tender 11 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_11_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Brndon/Tender11/RFPResponseTemplate-t11.pdf", Description: "This is the Tender 11 RFP mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Charles"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Negotiated"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 12", Description: "This is the twelvth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 45}) , Budget: 1300000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_12_RFP", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPDocument_t12.pdf", Description: "This is the Tender 12 RFP Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_12_RFP_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPResponseTemplate-t12.pdf", Description: "This is the Tender 12 RFP mandatory response template", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_12_RFP_Presentation", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Charles/Tender12/RFPPresentation_t12.pdf", Description: "This is the Tender 12 RFP Presentation", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (em:Employee {Name: "Donald"}), (nt:NewTenderS {Name: "NewTenderS"}) , (ty:TenderType {Name: "Open"}) 
CREATE (t1:Tender {TenderCode: "T"+left(randomUUID(),8)+right(randomUUID(),4), Title: "Tender 13", Description: "This is the thirteenth tender for testing purposes", SubmissionDate: localdatetime.transaction(), EndBidingDate: localdatetime.transaction() + duration({days: 30}) , Budget: 70000 })<-[:IS_NEW_TENDER_STATE]-(nt),
         (t1)-[:HAS_TENDER_DOCS]->(d:TenderDocS {Name: "TenderDocS"})-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_13_RFQ", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender13/RFQDocument_t13.pdf", Description: "This is the Tender 13 RFQ Document", Date: localdatetime.transaction()}),
         (d)-[:HAS_TENDER_DOCUMENT]->(:TenderDoc {DocName: "Tender_13_RFQ_ResponseTemplate", Type: "PDF", URL: "https://company-my.sharepoint.com/personal/Donald/Tender13/RFQResponseTemplate-t13.pdf", Description: "This is the Tender 13 RFQ mandatory response template", Date: localdatetime.transaction()}),
         (t1)-[:HAS_REQUESTER]->(em),
         (t1)-[:IS_TENDER_TYPE]->(ty),
         (t1)-[:HAS_TENDER_CHAT]->(:ConversatioN {Name: "ConversatioN"});
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 10"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"}),  (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1),
       (at)-[:IS_APPROVED_TENDER_STATE]->(t)
DELETE r1;  
...
MATCH (t:Tender {Title: "Tender 12"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1);

// Let’s have the L2 approver (Sara) approve the Tender 12
MATCH (t:Tender {Title: "Tender 12"}), (l2:Employee {Name: "Sara"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level2Approver"})
CREATE (t)-[:HAS_L2_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l2);
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 12"}), (l3:Employee {Name: "Christine"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level3Approver"}), (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L3_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l3),
       (at)-[:IS_APPROVED_TENDER_STATE]->(t)
DELETE r1;
...
MATCH (nt:NewTenderS {Name: "NewTenderS"})-[r1:IS_NEW_TENDER_STATE]->(t:Tender {Title: "Tender 13"}), (l1:Employee {Name: "Gloria"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Level1Approver"}),  (at:ApprovedTenderS {Name: "ApprovedTenderS"})
CREATE (t)-[:HAS_L1_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved"}]->(l1),
       (at)-[:IS_APPROVED_TENDER_STATE]->(t)
DELETE r1;  
...
// Now that we are publishing the Tender, we will also create the Tender's "InvitedVenrorS" collection to place the Vendors that will be invited and the TenderBidS collection
MATCH (at:ApprovedTenderS {Name: "ApprovedTenderS"})-[r1:IS_APPROVED_TENDER_STATE]->(t:Tender {Title: "Tender 10"}), (p:Employee {Name: "Cloe"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Publisher"}), (pt:PublishedTenderS {Name: "PublishedTenderS"})
CREATE (t)-[:HAS_PUBLISHER_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved for Publishing"}]->(p),
       (t)-[:HAS_INVITEES]->(:InvitedVendorS {Name: "InvitedVendorS"}),
       (t)-[:HAS_TENDER_BIDS]->(:TenderBidS {Name: "TenderBidS"}),
       (pt)-[:IS_PUBLISHED_TENDER_STATE]->(t)
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 10"})-[:HAS_INVITEES]->()-[:HAS_INVITATION]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 10)."})-[:SENT_BY]->(e);
...
// Now that we are publishing the Tender, we will also create the Tender's "InvitedVenrorS" collection to place the Vendors that will be invited and the TenderBidS collection
MATCH (at:ApprovedTenderS {Name: "ApprovedTenderS"})-[r1:IS_APPROVED_TENDER_STATE]->(t:Tender {Title: "Tender 12"}), (p:Employee {Name: "Cloe"})<-[:IS_ACTIVE_ROLE]-(:RolE {Name: "Publisher"}), (pt:PublishedTenderS {Name: "PublishedTenderS"})
CREATE (t)-[:HAS_PUBLISHER_TENDER_APPROVAL {Date: localdatetime.transaction(), Comment: "This tender is approved for Publishing"}]->(p),
       (t)-[:HAS_INVITEES]->(:InvitedVendorS {Name: "InvitedVendorS"}),
       (t)-[:HAS_TENDER_BIDS]->(:TenderBidS {Name: "TenderBidS"}),
       (pt)-[:IS_PUBLISHED_TENDER_STATE]->(t)
...
MATCH (v:Vendor {ShortName: "Vendor 10"})<-[:IS_VENDOR_STATE]-(:ApprovedVendorS)
        CREATE (iv)-[:HAS_INVITATION {Date: localdatetime.transaction()}]->(v);
...
MATCH (e:Employee {Name: "System"}), (t:Tender {Title: "Tender 12"})-[:HAS_INVITEES]->()-[:HAS_INVITATION]->(v)-[:HAS_VENDOR_CHAT]->(c:ConversatioN)  
CREATE (c)-[:HAS_MESSAGE { Date: localdatetime.transaction()}]->(m:Message {Text: "You have been Invited to participate on a tender (Tender 12)."})-[:SENT_BY]->(e);
